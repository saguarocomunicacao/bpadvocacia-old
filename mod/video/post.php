					...
					if(trim($_POST['acaoForm'])=="publicar") {
						...
						if(trim($_POST['acaoForm'])=="despublicar") {
							...
							if(trim($_POST['acaoForm'])=="config_seo") {
								...
								if(trim($_POST['idvideo_categoria'])=="") { $_POST['idvideo_categoria']=0; } else { $_POST['idvideo_categoria']=1; }
								...
								if($nEstrutura==0) { 
									...
									$update = mysql_query("UPDATE ".$mod."_estrutura SET 
																						 ...
																						 idvideo_categoria='".$_POST['idvideo_categoria']."',
																						 ...
																						 idvideo_categoria_label='".$_POST['idvideo_categoria_label']."',
																						 ...
																						 idvideo_categoria_info='".$_POST['idvideo_categoria_info']."',
