        <!-- main content -->
                                                    ...
                                                    <div class="span2">
                                                        <div class="w-box w-box">
                                                            ...
                                                            <div class="w-box-content">
                                                                ...
                                                                ?>
                                                                <div style="width:100%;float:left;margin-top:5px;cursor:pointer;" onclick="filtra_sysagenda('<?= $rSqlItem['id'] ?>','<?=$sysusu['id']?>','<?=$_REQUEST['var1']?>','<?=$_REQUEST['var2']?>','<?= $rSqlItem['cor'] ?>','1');">
            ...
            <script>filtra_sysagenda('','<?=$sysusu['id']?>','<?=$_REQUEST['var1']?>','<?=$_REQUEST['var2']?>','','0');</script>
