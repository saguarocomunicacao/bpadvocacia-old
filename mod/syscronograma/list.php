                                        ...
                                        <div class="tabbable tabbable-bordered">
											...
											beoro_enchancedSelect = {
												init: function() {
													...
													if($('#idsyscliente_rela').length) {
														$("#idsyscliente_rela").select2({
															placeholder: "Selecione um cliente",
															allowClear: true
														});
													}
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div id="tb1_editar" class="tab-pane active">
                                                                ...
                                                                <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data">
                                                                    ...
                                                                    <div class="formSep">
                                                                        <div style="float:left;margin-right:10px;padding-bottom:10px;width:300px;">
                                                                            ...
                                                                            <select name="idsyscliente" id="idsyscliente" onchange="busca_syscontrato_cliente('');" <? if(trim($row['criador'])==$sysusu['id']) { } else { ?>disabled="disabled"<? } ?> class="span12">
                                                                                <option value=""></option>
                                                                                <?
                                                                        ...
                                                                        <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                                            ...
                                                                            <?
                                                                            $itemN = mysql_num_rows(mysql_query("SELECT * FROM syscontrato WHERE idsyscliente='".$row['idsyscliente']."'"));
                                                                            if(trim($itemN)==0) { 
                                                                            ?>
                                                                            ...
                                                                            <select id="idsyscontrato" name="idsyscontrato" onchange="busca_syscontrato_item_cliente('');" <? if(trim($row['criador'])==$sysusu['id']) { } else { ?>disabled="disabled"<? } ?> >
                                                                                <option value="">---</option>
                                                                                <?
                                                                                $qSqlItem = mysql_query("SELECT * FROM syscontrato WHERE idsyscliente='".$row['idsyscliente']."' AND aceito='1' AND stat='1' ORDER BY data_aceito");
                                                                                while($rSqlItem = mysql_fetch_array($qSqlItem)) {
                                                                                ?>
                                                                ...
                                                                <form name="forms_tarefas" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms_tarefas">
                                                                    ...
                                                                    <div class="formSep">
                                                                            ...
                                                                            <div style="float:left;width:100%;">
                                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                                                    ...
                                                                                    <select name="ordem" id="ordem_item_editar" style="width:50px;">
                                                                                        <?
                                                                                        $nordem = mysql_num_rows(mysql_query("SELECT * FROM syscronograma_item WHERE numeroUnico_pai='".$numeroUnicoGerado_editar."'"));
                                                                                        if($nordem==0) {
                                                                                        ?>
                                                                        ...
                                                                        <div style="float:left;width:100%;display:none;" id="btns-editar_editar">
                                                                            ...
                                                                            <button type="button" onclick="cancela_edita_syscronograma_item('_editar','<?=$numeroUnicoGerado_editar?>');" style="margin-top:23px;" class="btn btn-warning">Cancelar</button>
                                                                        </div>
                                                                    </div>
                                                                    <? } ?>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="vertical-align:middle;" class="nolink">
																						...
																						<? if(trim($row['criador'])==$sysusu['id']) { ?>
                                                                                        <a href="javascript:void(0);" onclick="edita_syscronograma_item('<?=$rSqlCategoria['id']?>','_editar','<?=$numeroUnicoGerado_editar?>');" class="btn-mini ptip_se" title="Editar"><img src="<?=$link?>template/img/icones_novos/16/editar.png" /></a>

																						<? if(trim($rSqlCategoria['stat'])=="1") { ?>
                                                                                            <a href="javascript:void(0);" onclick="muda_stat_syscronograma_item('stat','dataModificacao','<?=$rSqlCategoria['id']?>','0');" class="btn-mini ptip_se" title="Desabilitar para 'Em Desenvolvimento'"><img src="<?=$link?>template/img/icones_novos/16/stat-1.png" /></a>
                                                                                        <? } else { ?>
                                                                                            <a href="javascript:void(0);" onclick="muda_stat_syscronograma_item('stat','dataModificacao','<?=$rSqlCategoria['id']?>','1');" class="btn-mini ptip_se" title="Habilitar para 'Em Desenvolvimento'"><img src="<?=$link?>template/img/icones_novos/16/stat-0.png" /></a>
                                                                                        <? } ?>
                                                                                        <? } ?>

                                                                                        <? if(trim($rSqlCategoria['concluido'])=="1") { ?>
                                                                                            <a href="javascript:void(0);" onclick="muda_stat_syscronograma_item('concluido','dataConclusao','<?=$rSqlCategoria['id']?>','0');" class="btn-mini ptip_se" title="Concluído"><img src="<?=$link?>template/img/icones_novos/16/lupa-1.png" /></a>
                                                                                        <? } else { ?>
                                                                                            <a href="javascript:void(0);" onclick="muda_stat_syscronograma_item('concluido','dataConclusao','<?=$rSqlCategoria['id']?>','1');" class="btn-mini ptip_se" title="Concluir"><img src="<?=$link?>template/img/icones_novos/16/lupa-0.png" /></a>
                                                                                        <? } ?>

                                                                                        <? if(trim($rSqlCategoria['aprovado'])=="1") { ?>
                                                                                            <a href="javascript:void(0);" <? if(trim($row['criador'])==$sysusu['id']) { ?>onclick="muda_stat_syscronograma_item('aprovado','dataAprovacao','<?=$rSqlCategoria['id']?>','0');"<? } else { ?>onclick="alert('Você não tem permissão para esta ação !');"<? } ?> class="btn-mini ptip_se" title="Aprovado"><img src="<?=$link?>template/img/like-1.png" /></a>
                                                                                        <? } else { ?>
                                                                                            <a href="javascript:void(0);" <? if(trim($row['criador'])==$sysusu['id']) { ?>onclick="muda_stat_syscronograma_item('aprovado','dataAprovacao','<?=$rSqlCategoria['id']?>','1');"<? } else { ?>onclick="alert('Você não tem permissão para esta ação !');"<? } ?> class="btn-mini ptip_se" title="Aprovar"><img src="<?=$link?>template/img/like-0.png" /></a>
                                                                                        <? } ?>
                                                    ...
                                                    <div class="formSep">
                                                        ...
                                                        <? if(trim($row['criador'])==$sysusu['id']) { ?>
                                                        <button type="button" onclick="salvar_syscronograma();" class="btn btn-success">Salvar</button>
                                                        <button type="button" onclick="salvar_continuar_editando_syscronograma();" class="btn btn-primary">Salvar e continuar editando</button>
                                                        <? } ?>
                                                        <? if(trim($row['situacao'])=="analise"&&$concluido==$nSqlTarefa&&$aprovado==$nSqlTarefa&&$nSqlTarefa>0) { ?>
                                                        <button type="button" onclick="salvar_muda_situacao_syscronograma('aprovado');" class="btn btn-beoro-2">Aprovar e Concluir</button>
                                                        <? } ?>
                                                        <? if(trim($row['criador'])==$sysusu['id']) { ?>
														<? if(trim($row['situacao'])=="analise") { ?>
                                                        <button type="button" onclick="salvar_muda_situacao_syscronograma('desenvolvimento');" class="btn btn-info">Enviar para Desenvolvimento</button>
                                                        <? } ?>
                                                        <? } ?>
                                                        <? if(trim($row['situacao'])=="desenvolvimento"&&$concluido==$nSqlTarefa&&$aprovado<$nSqlTarefa) { ?>
                                                        <button type="button" onclick="salvar_muda_situacao_syscronograma('analise');" class="btn btn-warning">Enviar para Análise</button>
                                                        <? } ?>
                                                        <? } ?>
                                                    </div>
                                                ...
                                                <div id="tb1_novo" class="tab-pane">
                                                    ...
                                                    <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                        ...
                                                        <div class="formSep">
                                                            <div class="span4">
                                                                <label id="label-perfil">Cliente</label>
                                                                <select name="idsyscliente" id="idsyscliente" onchange="busca_syscontrato_cliente('');" class="span12">
                                                                    <option value=""></option>
                                                                    <?
                                                                    $qSqlCat = mysql_query("SELECT * FROM syscliente_categoria WHERE stat='1' ORDER BY nome");
                                                                    while($rSqlCat = mysql_fetch_array($qSqlCat)) {
                                                ...
                                                <div id="tb1_relatorio" class="tab-pane">
                                                    ...
                                                    <form name="forms_relatorio" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms_relatorio">
                                                        <div class="formSep">
                                                            <label id="label-perfil">Cliente</label>
                                                            <select id="idsyscliente_rela" class="span7">
                                                                <option value=""></option>
                                                                <?
                                                                $qSqlCat = mysql_query("SELECT * FROM syscliente_categoria WHERE stat='1' ORDER BY nome");
                                                                while($rSqlCat = mysql_fetch_array($qSqlCat)) {
                                                        ...
                                                        <div class="formSep">
                                                            <button type="button" onclick="gerar_relatorio_syscronograma('<?=$mod?>','<?=$sysusu['id']?>');" class="btn btn-success">Gerar Relatório</button>
