                                                ...
                                                <div id="tb1_lista" class="tab-pane <? if(trim($_REQUEST['var3'])=="") { ?>active<? } ?>">
                                                    ...
                                                    <div class="span2">
                                                        ...
                                                        <div style="width:100%;float:left;border-bottom:1px solid #CCC;padding-bottom:5px;">
                                                            ...
                                                            <?
                                                            $qSqlItem = mysql_query("SELECT * FROM sysagenda_categoria WHERE criador='".$sysusu['id']."' AND  stat='1' ORDER BY ordem");
                                                            ...
                                                            if(trim($sysperm['todos_adv_processo_tipo'])==1) {
																$qSqlItem = mysql_query("SELECT * FROM adv_processo_tipo WHERE stat='1' ORDER BY ordem");
															} else {
																$qSqlItem = mysql_query("SELECT * FROM adv_processo_tipo WHERE lista_admin LIKE '%|".$sysusu['id']."|%' AND stat='1' ORDER BY ordem");
															}
                                                            while($rSqlItem = mysql_fetch_array($qSqlItem)) {
