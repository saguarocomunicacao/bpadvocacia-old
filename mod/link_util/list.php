                                        ...
                                        <div class="tabbable tabbable-bordered">
                                            ...
                                            <div class="tab-content">
                                                            ...
                                                            <? } ?>
                                                             ...
                                                             <div class="formSep">
                                                                ...
                                                                <select name="id<?=$mod?>_categoria" id="id<?=$mod?>_categoria">
                                                                    <option value="">---</option>
                                                                    <?
                                                                    $qSqlItem = mysql_query("SELECT * FROM ".$linguagem_set."".$mod."_categoria ORDER BY nome");
                                                ...
                                                <div id="tb1_lista" class="tab-pane <? if(trim($_REQUEST['var3'])=="") { ?>active<? } ?>">
                                                    <div class="w-box w-box">
                                                        ...
                                                        <div class="w-box-content">
                                                            <form name="list" action="<?=$link?><?=$_REQUEST['var2']?>" method="post" target="_self">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr id="linha-<?=$rSql['id']?>">
                                                                    ...
                                                                    <td style="vertical-align:middle;" class="nolink">
                                                                        <div class="btn-group">
                                                                        <? if(trim($sysperm['editar_'.$mod.''])==1) { ?><a href="<?=$link?><?=$_REQUEST['var2']?>/editar/<?=$rSql['id']?>/" class="btn-mini ptip_se" title="Editar"><img src="<?=$link?>template/img/icones_novos/16/editar.png" /></a><? } ?>
                                                ...
                                                <div id="tb1_categorias" class="tab-pane">
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data">
                                                            <input type="hidden" name="acaoLocal" value="interno" />
                                                            <input type="hidden" name="acaoForm" value="add" />
                                                    ...
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                ...
                                                                <div style="float:left;margin-right:10px;width:100%;">
                                                                    <label>Informações Extras</label>
                                                                    <input value="<?=$row_estrutura['link_info']?>"class="span7" type="text" name="link_info" id="link_info" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    ...
                                                                    <select name="campo_ordem_1" id="campo_ordem_1">
                                                                        ...
                                                                        <option value='link' <? if($row_estrutura['campo_ordem_1']=="link") { echo "selected"; } ?>><? if(trim($row_estrutura['link_label'])=="") { echo "Cargo"; } else { echo $row_estrutura['link_label']; } ?></option>
                                                                    </select>
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    ...
                                                                    <select name="campo_ordem_2" id="campo_ordem_2">
                                                                        ...
                                                                        <option value='link' <? if($row_estrutura['campo_ordem_2']=="link") { echo "selected"; } ?>><? if(trim($row_estrutura['link_label'])=="") { echo "Cargo"; } else { echo $row_estrutura['link_label']; } ?></option>
                                                                    </select>
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
