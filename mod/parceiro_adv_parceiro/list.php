                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div id="tb1_editar" class="tab-pane active">
                                                    ...
                                                    <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="formulario">
                                                        ...
                                                        <?
                                                        $qSqlTipo = mysql_query("SELECT * FROM parceiro_adv_processo_tipo WHERE stat='1' ORDER BY ordem");
                                                        ...
                                                        <div class="formSep">
                                                            ...
                                                            <? 
															$nTipoAuth = mysql_num_rows(mysql_query("SELECT * FROM ".$mod." WHERE idsysusu='".$_REQUEST['var4']."' AND idparceiro_adv_processo_tipo='".$rSqlTipo['id']."' AND auth='1'"));
															if($nTipoAuth==0) {
																$nTipoAuth = mysql_num_rows(mysql_query("SELECT * FROM ".$mod." WHERE idsysusu='".$_REQUEST['var4']."' AND idparceiro_adv_processo_tipo='".$rSqlTipo['id']."' AND auth='0'"));
																if($nTipoAuth==0) {
																	$auth_0 = "";
																	$auth_1 = "checked";
																} else {
                                                            ...
                                                            <? 
															$nTipoVer = mysql_num_rows(mysql_query("SELECT * FROM ".$mod." WHERE idsysusu='".$_REQUEST['var4']."' AND idparceiro_adv_processo_tipo='".$rSqlTipo['id']."' AND ver='1'"));
															if($nTipoVer==0) {
																$nTipoVer = mysql_num_rows(mysql_query("SELECT * FROM ".$mod." WHERE idsysusu='".$_REQUEST['var4']."' AND idparceiro_adv_processo_tipo='".$rSqlTipo['id']."' AND ver='0'"));
																if($nTipoVer==0) {
																	$ver_0 = "";
																	$ver_1 = "checked";
																} else {
                                                            ...
                                                            <? 
															$nTipoEditar = mysql_num_rows(mysql_query("SELECT * FROM ".$mod." WHERE idsysusu='".$_REQUEST['var4']."' AND idparceiro_adv_processo_tipo='".$rSqlTipo['id']."' AND editar='1'"));
															if($nTipoEditar==0) {
																$nTipoEditar = mysql_num_rows(mysql_query("SELECT * FROM ".$mod." WHERE idsysusu='".$_REQUEST['var4']."' AND idparceiro_adv_processo_tipo='".$rSqlTipo['id']."' AND editar='0'"));
																if($nTipoEditar==0) {
																	$editar_0 = "";
																	$editar_1 = "checked";
																} else {
                                                            ...
                                                            <? 
															$nTipoExcluir = mysql_num_rows(mysql_query("SELECT * FROM ".$mod." WHERE idsysusu='".$_REQUEST['var4']."' AND idparceiro_adv_processo_tipo='".$rSqlTipo['id']."' AND excluir='1'"));
															if($nTipoExcluir==0) {
																$nTipoExcluir = mysql_num_rows(mysql_query("SELECT * FROM ".$mod." WHERE idsysusu='".$_REQUEST['var4']."' AND idparceiro_adv_processo_tipo='".$rSqlTipo['id']."' AND excluir='0'"));
																if($nTipoExcluir==0) {
																	$excluir_0 = "";
																	$excluir_1 = "checked";
																} else {
                                                            ...
                                                            <? 
															$nTipoDespublicar = mysql_num_rows(mysql_query("SELECT * FROM ".$mod." WHERE idsysusu='".$_REQUEST['var4']."' AND idparceiro_adv_processo_tipo='".$rSqlTipo['id']."' AND despublicar='1'"));
															if($nTipoDespublicar==0) {
																$nTipoDespublicar = mysql_num_rows(mysql_query("SELECT * FROM ".$mod." WHERE idsysusu='".$_REQUEST['var4']."' AND idparceiro_adv_processo_tipo='".$rSqlTipo['id']."' AND despublicar='0'"));
																if($nTipoDespublicar==0) {
																	$despublicar_0 = "";
                                                            ...
                                                            <? 
															$nTipoPublicar = mysql_num_rows(mysql_query("SELECT * FROM ".$mod." WHERE idsysusu='".$_REQUEST['var4']."' AND idparceiro_adv_processo_tipo='".$rSqlTipo['id']."' AND publicar='1'"));
															if($nTipoPublicar==0) {
																$nTipoPublicar = mysql_num_rows(mysql_query("SELECT * FROM ".$mod." WHERE idsysusu='".$_REQUEST['var4']."' AND idparceiro_adv_processo_tipo='".$rSqlTipo['id']."' AND publicar='0'"));
																if($nTipoPublicar==0) {
																	$publicar_0 = "";
																	$publicar_1 = "checked";
																} else {
                                                ...
                                                <div id="tb1_lista" class="tab-pane <? if(trim($_REQUEST['var3'])=="") { ?>active<? } ?>">
                                                    <div class="w-box w-box">
                                                        ...
                                                        <div class="w-box-content">
                                                            ...
                                                            <tbody>
                                                                <?
																$qSql = mysql_query("SELECT * FROM ".$linguagem_set."sysusu WHERE idsysusu_categoria='5' ORDER BY nome");
