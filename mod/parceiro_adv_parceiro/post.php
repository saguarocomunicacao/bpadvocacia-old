<?
	...
	if(trim($_POST['acaoForm'])=="add") {
		...
		$_POST['visualizar_parceiro_adv_processo']=1;          
		$_POST['inserir_parceiro_adv_processo']=1;            
		$_POST['editar_parceiro_adv_processo']=1;           
		$_POST['excluir_parceiro_adv_processo']=1;             
		$_POST['publicar_parceiro_adv_processo']=1;            
		$_POST['despublicar_parceiro_adv_processo']=1;           
		$_POST['lixeira_parceiro_adv_processo']=1;           
		$_POST['restaurar_parceiro_adv_processo']=1;             
		$_POST['descricao_parceiro_adv_processo']=1;      
		$_POST['seo_parceiro_adv_processo']=1;           

		$_POST['visualizar_parceiro_adv_processo_tipo']=1;          
		$_POST['inserir_parceiro_adv_processo_tipo']=1;            
		$_POST['editar_parceiro_adv_processo_tipo']=1;           
		$_POST['excluir_parceiro_adv_processo_tipo']=1;             
		$_POST['publicar_parceiro_adv_processo_tipo']=1;            
		$_POST['despublicar_parceiro_adv_processo_tipo']=1;           
		$_POST['lixeira_parceiro_adv_processo_tipo']=1;           
		$_POST['restaurar_parceiro_adv_processo_tipo']=1;             
		$_POST['descricao_parceiro_adv_processo_tipo']=1;      
		$_POST['seo_parceiro_adv_processo_tipo']=1;           
		...
		if(trim($_POST['acaoForm'])=="add-continuar") {
			...
			while($rSqlTipo = mysql_fetch_array($qSqlTipo)) {
				$nTipo = mysql_num_rows(mysql_query("SELECT * FROM ".$mod." WHERE idsysusu='".$_POST['iditem']."' AND idparceiro_adv_processo_tipo='".$rSqlTipo['id']."'"));
				if($nTipo==0) {
					...
					$item = mysql_fetch_array(mysql_query("SELECT * FROM ".$mod." WHERE idsysusu='".$_POST['iditem']."' AND idparceiro_adv_processo_tipo='".$rSqlTipo['id']."'"));
