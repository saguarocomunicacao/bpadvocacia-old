					...
					if(trim($_POST['acaoForm'])=="publicar") {
						...
						if(trim($_POST['acaoForm'])=="despublicar") {
							...
							if(trim($_POST['acaoForm'])=="config_seo") {
								...
								if(trim($_POST['idsysfaq_categoria'])=="") { $_POST['idsysfaq_categoria']=0; } else { $_POST['idsysfaq_categoria']=1; }
								...
								if($nEstrutura==0) { 
									$insert = mysql_query("INSERT INTO ".$mod."_estrutura (
																						  ...
																						  '".$_POST['idsysfaq_categoria_label']."',
									...
									$update = mysql_query("UPDATE ".$mod."_estrutura SET 
																						 ...
																						 idsysfaq_categoria='".$_POST['idsysfaq_categoria']."',
																						 ...
																						 idsysfaq_categoria_label='".$_POST['idsysfaq_categoria_label']."',
																						 ...
																						 idsysfaq_categoria_info='".$_POST['idsysfaq_categoria_info']."',
