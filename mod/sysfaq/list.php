        <!-- main content -->
            <div class="container-fluid">
                <div class="row-fluid">
                    ...
                    <div class="span10">
                        <div class="w-box">
                                <? if(trim($sysperm['visualizar_'.$mod.''])==1&&trim($sysperm['inserir_'.$mod.''])==0&&trim($sysperm['editar_'.$mod.''])==0&&trim($sysperm['excluir_'.$mod.''])==0) { ?>
                                <script>
                                    ...
                                    <div class="span12">
                                        <div class="tabbable tabbable-bordered">
                                            ...
                                            <div class="accordion" id="accordion1">
                                                ...
                                                <?
												if(trim($row_estrutura['lista_sysgrupousuario'])==1) {
													$qSql = mysql_query("SELECT * FROM ".$linguagem_set."".$mod." WHERE lista_sysgrupousuario LIKE '%|".$sysusu['idsysgrupousuario']."|%' ORDER BY ordem");
												} else {
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapse<?=$rSql['id']?>">
                                                            <?=$rSql['nome']?>
                                                        </a>
                                                    </div>
                                                    <div id="collapse<?=$rSql['id']?>" class="accordion-body collapse">
                                                        <div class="accordion-inner"><?=$rSql['texto']?></div>
                                                    </div>
                                                </div>
                                                <? } ?>
                                    ...
                                    <div class="span12">
                                        <div class="tabbable tabbable-bordered">
                                            <ul class="nav nav-tabs">
                                                ...
                                                <? if(trim($row_estrutura['nome_seo'])==1||trim($row_estrutura['titulo_texto'])==1||trim($row_estrutura['imagem_descricao'])==1||trim($row_estrutura['imagem_interna'])==1||trim($row_estrutura['chamada_descricao'])==1||trim($row_estrutura['texto_descricao'])==1) { ?>
											...
											beoro_multiselect = {
												init: function(){
													if($('#lista_sysgrupousuario_itens').length) {
														//* searchable
														$('#lista_sysgrupousuario_itens').multiSelect({
															...
															afterSelect: function(values){
																$('#lista_sysgrupousuario').val(""+$('#lista_sysgrupousuario').val()+'|'+values+'|');
															},
															afterDeselect: function(values){
																$('#lista_sysgrupousuario').val($('#lista_sysgrupousuario').val().replace('|'+values+'|',''));
															}
  														});
													}
													<? if(trim($_REQUEST['var3'])=="") { } else { ?>
													if($('#lista_sysgrupousuario_itens_editar').length) {
														//* searchable
														$('#lista_sysgrupousuario_itens_editar').multiSelect({
															selectableHeader: '<div class="search-header"><input type="text" class="span12" id="ms-search" autocomplete="off" placeholder="Digite aqui sua busca"></div>',
															selectionHeader: "<div class='search-selected'></div>",
															afterSelect: function(values){
																$('#lista_sysgrupousuario_editar').val(""+$('#lista_sysgrupousuario_editar').val()+'|'+values+'|');
															},
															afterDeselect: function(values){
																$('#lista_sysgrupousuario_editar').val($('#lista_sysgrupousuario_editar').val().replace('|'+values+'|',''));
															}
  														});
													}
													<? } ?>
											...
											beoro_switchButtons = {
												init: function() {
													...
													if($('#lista_sysgrupousuario_estrutura').length) { $("#lista_sysgrupousuario_estrutura").iButton(); }
                                                        ...
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;width:550px;">
                                                                    <label><? if(trim($row_estrutura['lista_sysgrupousuario_label'])=="") { echo "Escolha a categoria"; } else { echo $row_estrutura['lista_sysgrupousuario_label']; } ?></label>
                                                                    <select id="lista_sysgrupousuario_itens_editar" multiple="multiple">
                                                                        <?
                                                                        $qSqlItem = mysql_query("SELECT * FROM sysgrupousuario ORDER BY nome");
                                                                        while($rSqlItem = mysql_fetch_array($qSqlItem)) {
                                                                        ?>
                                                                        <option value="<?=$rSqlItem['id']?>" <? if(strrpos($row['lista_sysgrupousuario'],"|".$rSqlItem['id']."|") === false) { } else { echo "selected"; } ?>><?=$rSqlItem['nome']?></option>
                                                                        <? } ?>
                                                                    </select>
                                                                    <input value="<?=$row['lista_sysgrupousuario']?>" style="width:350px;" type="hidden" name="lista_sysgrupousuario" id="lista_sysgrupousuario_editar" />
                                                                </div>
                                                                <? if(trim($row_estrutura['lista_sysgrupousuario_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;"><?=$row_estrutura['lista_sysgrupousuario_info']?></span><? } ?>
                                                            </div>
                                                            <? } ?>
                                                    ...
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;width:550px;">
                                                                    <label><? if(trim($row_estrutura['lista_sysgrupousuario_label'])=="") { echo "Escolha a categoria"; } else { echo $row_estrutura['lista_sysgrupousuario_label']; } ?></label>
                                                                    <select id="lista_sysgrupousuario_itens" multiple="multiple">
                                                                        <?
                                                                        $qSqlItem = mysql_query("SELECT * FROM sysgrupousuario ORDER BY nome");
                                                                        while($rSqlItem = mysql_fetch_array($qSqlItem)) {
                                                                        ?>
                                                                    ...
                                                                    <input value="" style="width:350px;" type="hidden" name="lista_sysgrupousuario" id="lista_sysgrupousuario" />
                                                                </div>
                                                                <? if(trim($row_estrutura['lista_sysgrupousuario_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;"><?=$row_estrutura['lista_sysgrupousuario_info']?></span><? } ?>
                                                            </div>
                                                            <? } ?>
                                                ...
                                                <div id="tb1_estrutura" class="tab-pane">
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label class="req">Campo 'Grupos de Usuários'</label>
                                                                    <input value="<?=$row_estrutura['lista_sysgrupousuario_label']?>"  style="width:350px;" type="text" name="lista_sysgrupousuario_label" id="lista_sysgrupousuario_label" />
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                                    <label>Ativo ?</label>
                                                                    <input type="checkbox" name="lista_sysgrupousuario" id="lista_sysgrupousuario_estrutura" <? if(trim($row_estrutura['lista_sysgrupousuario'])==1) { echo " checked"; } ?> class="lista_sysgrupousuario_estrutura {labelOn: 'SIM', labelOff: 'NÃO'}" />
                                                                </div>
                                                                <div style="float:left;margin-right:10px;width:100%;">
                                                                    <label>Informações Extras</label>
                                                                    <input value="<?=$row_estrutura['lista_sysgrupousuario_info']?>"class="span7" type="text" name="lista_sysgrupousuario_info" id="lista_sysgrupousuario_info" />
                                                                </div>
                                                            </div>
