		...
		if(trim($_POST['acaoForm'])=="editar") {
			...
			if(trim($_POST['acaoForm'])=="config") {
				...
				if($nConfig==0) { 
					...
					$insert = mysql_query("INSERT INTO ".$mod."_config (nome,link_login,imagem_descricao,imagem_interna,chamada_descricao,texto_descricao,titulo_texto) VALUES ('".$_POST['nome']."','".$_POST['link_login']."','".$_POST['imagem_descricao']."','".$_POST['imagem_interna']."','".$_POST['chamada_descricao']."','".$_POST['texto_descricao']."','".$_POST['titulo_texto']."')");
				} else {
					...
					$update = mysql_query("UPDATE ".$mod."_config SET nome='".$_POST['nome']."',link_login='".$_POST['link_login']."',imagem_descricao='".$_POST['imagem_descricao']."',imagem_interna='".$_POST['imagem_interna']."',chamada_descricao='".$_POST['chamada_descricao']."',texto_descricao='".$_POST['texto_descricao']."',titulo_texto='".$_POST['titulo_texto']."' WHERE id='".$itemAtual['id']."'");
				}
			} else {
				if(trim($_POST['acaoForm'])=="config_seo") {
					...
					if(trim($_POST['link_login'])=="") { $_POST['link_login']=0; } else { $_POST['link_login']=1; }
					...
					if($nEstrutura==0) { 
						$insert = mysql_query("INSERT INTO ".$mod."_estrutura (seo,
						                                                    nome,
																			link_login,
						                                                    imagem_descricao,
																			imagem_interna,
						...
						$update = mysql_query("UPDATE ".$mod."_estrutura SET 
						                                                     ...
						                                                     link_login_label='".$_POST['link_login_label']."',
						                                                     ...
						                                                     link_login_info='".$_POST['link_login_info']."',
