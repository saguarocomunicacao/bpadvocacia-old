                                        ...
                                        <div class="tabbable tabbable-bordered">
											...
											beoro_switchButtons = {
												init: function() {
													...
													if($('#cargo_estrutura').length) { $("#cargo_estrutura").iButton(); }
                                                ...
                                                <div id="tb1_editar" class="tab-pane active">
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <? if(trim($row_estrutura['cargo'])==1) { ?>
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label><? if(trim($row_estrutura['cargo_label'])=="") { echo "Cargo"; } else { echo $row_estrutura['cargo_label']; } ?></label>
                                                                    <input value="<?=$row['cargo']?>" style="width:350px;" type="text" name="cargo" id="cargo" />
                                                                </div>
                                                                <? if(trim($row_estrutura['cargo_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;"><?=$row_estrutura['cargo_info']?></span><? } ?>
                                                            </div>
                                                            <? } ?>
                                                    ...
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label><? if(trim($row_estrutura['cargo_label'])=="") { echo "Cargo"; } else { echo $row_estrutura['cargo_label']; } ?></label>
                                                                    <input value="" style="width:350px;" type="text" name="cargo" id="cargo" />
                                                                </div>
                                                                <? if(trim($row_estrutura['cargo_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;"><?=$row_estrutura['cargo_info']?></span><? } ?>
                                                            </div>
                                                            <? } ?>
                                                ...
                                                <div id="tb1_estrutura" class="tab-pane">
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label class="req">Campo 'Cargo'</label>
                                                                    <input value="<?=$row_estrutura['cargo_label']?>"  style="width:350px;" type="text" name="cargo_label" id="cargo_label" />
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                                    <label>Ativo ?</label>
                                                                    <input type="checkbox" name="cargo" id="cargo_estrutura" <? if(trim($row_estrutura['cargo'])==1) { echo " checked"; } ?> class="cargo_estrutura {labelOn: 'SIM', labelOff: 'NÃO'}" />
                                                                </div>
                                                                <div style="float:left;margin-right:10px;width:100%;">
                                                                    <label>Informações Extras</label>
                                                                    <input value="<?=$row_estrutura['cargo_info']?>"class="span7" type="text" name="cargo_info" id="cargo_info" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    ...
                                                                    <select name="campo_ordem_1" id="campo_ordem_1">
                                                                        ...
                                                                        <option value='cargo' <? if($row_estrutura['campo_ordem_1']=="cargo") { echo "selected"; } ?>><? if(trim($row_estrutura['cargo_label'])=="") { echo "Cargo"; } else { echo $row_estrutura['cargo_label']; } ?></option>
                                                                    </select>
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    ...
                                                                    <select name="campo_ordem_2" id="campo_ordem_2">
                                                                        ...
                                                                        <option value='cargo' <? if($row_estrutura['campo_ordem_2']=="cargo") { echo "selected"; } ?>><? if(trim($row_estrutura['cargo_label'])=="") { echo "Cargo"; } else { echo $row_estrutura['cargo_label']; } ?></option>
                                                                    </select>
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
