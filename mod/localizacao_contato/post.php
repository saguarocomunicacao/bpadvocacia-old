					...
					if(trim($_POST['acaoForm'])=="publicar") {
						...
						if(trim($_POST['acaoForm'])=="despublicar") {
							...
							if(trim($_POST['acaoForm'])=="config_seo") {
								...
								if(trim($_POST['url_google'])=="") { $_POST['url_google']=0; } else { $_POST['url_google']=1; }
								...
								if($nEstrutura==0) { 
									$insert = mysql_query("INSERT INTO ".$mod."_estrutura (
																						  ...
																						  '".$_POST['imagem_label']."',
																						  '".$_POST['texto_label']."',
																						  '".$_POST['url_google_label']."',
																						  
																						  '".$_POST['ordem_info']."',
																						  '".$_POST['nome_info']."',
																						  '".$_POST['imagem_info']."',
																						  '".$_POST['texto_info']."',
																						  '".$_POST['url_google_info']."'
