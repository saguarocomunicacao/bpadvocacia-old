		...
		if(trim($_POST['acaoForm'])=="editar") {
			...
			if(trim($_POST['acaoForm'])=="config") {
				...
				if($nConfig==0) { 
					...
					$insert = mysql_query("INSERT INTO ".$mod."_config (nome,imagem_descricao,chamada_descricao,texto_descricao) VALUES ('".$_POST['nome']."','".$_POST['imagem_descricao']."','".$_POST['chamada_descricao']."','".$_POST['texto_descricao']."')");
				} else {
					...
					$update = mysql_query("UPDATE ".$mod."_config SET nome='".$_POST['nome']."',imagem_descricao='".$_POST['imagem_descricao']."',chamada_descricao='".$_POST['chamada_descricao']."',texto_descricao='".$_POST['texto_descricao']."' WHERE id='".$itemAtual['id']."'");
				}
			} else {
					...
					if(trim($_POST['acaoForm'])=="publicar") {
						...
						if(trim($_POST['acaoForm'])=="despublicar") {
							...
							if(trim($_POST['acaoForm'])=="config_seo") {
								...
								if(trim($_POST['transicao'])=="") { $_POST['transicao']=0; } else { $_POST['transicao']=1; }
								...
								if($nEstrutura==0) { 
									...
									$update = mysql_query("UPDATE ".$mod."_estrutura SET 
																						 ...
																						 transicao_label='".$_POST['transicao_label']."',
																						 ...
																						 transicao_info='".$_POST['transicao_info']."',
