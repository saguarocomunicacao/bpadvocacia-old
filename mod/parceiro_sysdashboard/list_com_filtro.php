        <!-- main content -->
                                ...
                                <div class="row-fluid">
                                    <div class="span12">
                                        <div class="tabbable tabbable-bordered">
                                            ...
                                            <style>
											.myClassparceiro_syscronograma {
											   padding-left: 20px;
											   background-image: url("<?=$link?>template/img/icones_novos/16/parceiro_syscronograma.jpg");
											   background-repeat: no-repeat;
											   background-position: 2px 50%;
											}	
											.myClassparceiro_sysagenda {
											   padding-left: 20px;
											   background-image: url("<?=$link?>template/img/icones_novos/16/parceiro_sysagenda.jpg");
											   background-repeat: no-repeat;
											   background-position: 2px 50%;
											}
											.myClassparceiro_sysagenda .fc-event-title {
												font-weight:bold;
											...
											.myClassparceiro_adv_processo {
											   padding-left: 20px;
											   background-image: url("<?=$link?>template/img/icones_novos/16/parceiro_adv_processo.jpg");
											   background-repeat: no-repeat;
											   background-position: 2px 50%;
											}	
											.myClassparceiro_adv_processo_agenda {
											   padding-left: 20px;
											   background-image: url("<?=$link?>template/img/icones_novos/16/parceiro_adv_processo_agenda.jpg");
											   background-repeat: no-repeat;
											   background-position: 2px 50%;
											}	
                                                ...
                                                <div id="tb1_lista" class="tab-pane <? if(trim($_REQUEST['var3'])=="") { ?>active<? } ?>">
                                                    ...
                                                    <div class="span2">
                                                        ...
                                                        <div style="width:100%;float:left;border-bottom:1px solid #CCC;padding-bottom:5px;">
                                                            ...
                                                            <div style="width:100%;float:left;margin-top:5px;cursor:pointer;" onclick="filtra_parceiro_sysdashboard('<?=$sysusu['id']?>','analise','1','parceiro_syscronograma','faa732');">
                                                                <input id="check-analise-parceiro_syscronograma" type="checkbox" checked="checked" value="1" style="display:none;" />
                                                                <div id="div-cor-analise-parceiro_syscronograma" style="float:left;width:10px;height:10px;background-color:#faa732;border:1px solid #faa732;margin-top:4px;"></div>
                                                                <div style="float:left;margin-left:5px;font-size:11px;">Em Análise</div>
                                                            </div>

                                                            <div style="width:100%;float:left;margin-top:5px;cursor:pointer;" onclick="filtra_parceiro_sysdashboard('<?=$sysusu['id']?>','desenvolvimento','1','parceiro_syscronograma','49afcd');">
                                                                <input id="check-desenvolvimento-parceiro_syscronograma" type="checkbox" checked="checked" value="1" style="display:none;" />
                                                                <div id="div-cor-desenvolvimento-parceiro_syscronograma" style="float:left;width:10px;height:10px;background-color:#49afcd;border:1px solid #49afcd;margin-top:4px;"></div>
                                                                <div style="float:left;margin-left:5px;font-size:11px;">Em Desenvolvimento</div>
                                                            </div>

                                                            <div style="width:100%;float:left;margin-top:5px;cursor:pointer;" onclick="filtra_parceiro_sysdashboard('<?=$sysusu['id']?>','aprovado','1','parceiro_syscronograma','4e7562');">
                                                                <input id="check-aprovado-parceiro_syscronograma" type="checkbox" checked="checked" value="1" style="display:none;" />
                                                                <div id="div-cor-aprovado-parceiro_syscronograma" style="float:left;width:10px;height:10px;background-color:#4e7562;border:1px solid #4e7562;margin-top:4px;"></div>
                                                                <div style="float:left;margin-left:5px;font-size:11px;">Aprovadas e Concluídas</div>
                                                            </div>
                                                            
                                                            <input type="hidden" id="lista-categorias-parceiro_syscronograma" value="|aprovado||desenvolvimento||analise|" />
                                                            ...
                                                            <?
                                                            $qSqlItem = mysql_query("SELECT * FROM parceiro_sysagenda_categoria WHERE criador='".$sysusu['id']."' AND  stat='1' ORDER BY ordem");
                                                            while($rSqlItem = mysql_fetch_array($qSqlItem)) {
                                                                if(trim($lista_categorias_parceiro_sysagenda)=="") {
                                                                    $lista_categorias_parceiro_sysagenda = "|".$rSqlItem['id']."|";
                                                                } else {
                                                                    $lista_categorias_parceiro_sysagenda = $lista_categorias_parceiro_sysagenda."|".$rSqlItem['id']."|";
                                                                }
                                                            ?>
                                                            <div style="width:100%;float:left;margin-top:5px;cursor:pointer;" onclick="filtra_parceiro_sysdashboard('<?=$sysusu['id']?>','<?= $rSqlItem['id'] ?>','1','parceiro_sysagenda','<?= $rSqlItem['cor'] ?>');">
                                                                <input id="check-<?= $rSqlItem['id'] ?>-parceiro_sysagenda" type="checkbox" checked="checked" value="1" style="display:none;" />
                                                                <div id="div-cor-<?= $rSqlItem['id'] ?>-parceiro_sysagenda" style="float:left;width:10px;height:10px;background-color:<?= $rSqlItem['cor'] ?>;border:1px solid <?= $rSqlItem['cor'] ?>;margin-top:4px;"></div>
                                                                <div style="float:left;margin-left:5px;font-size:11px;"><?=$rSqlItem['nome']?></div>
                                                            </div>
                                                            <? } ?>
                                                            
                                                            <input type="hidden" id="lista-categorias-parceiro_sysagenda" value="<?=$lista_categorias_parceiro_sysagenda?>" />
                                                            ...
                                                            ?>
                                                            <div style="width:100%;float:left;margin-top:5px;cursor:pointer;" onclick="filtra_parceiro_sysdashboard('<?=$sysusu['id']?>','<?= $rSqlItem['id'] ?>','1','sysconta_a_pagar','999');">
                                                            ...
                                                            ?>
                                                            <div style="width:100%;float:left;margin-top:5px;cursor:pointer;" onclick="filtra_parceiro_sysdashboard('<?=$sysusu['id']?>','<?= $rSqlItem['id'] ?>','1','sysconta_a_receber','999');">
                                                            ...
                                                            <div style="width:100%;float:left;margin-top:5px;cursor:pointer;" onclick="filtra_parceiro_sysdashboard('<?=$sysusu['id']?>','0','1','parceiro_adv_processo','000');">
                                                                <input id="check-0-parceiro_adv_processo" type="checkbox" checked="checked" value="1" style="display:none;" />
                                                                <div id="div-cor-0-parceiro_adv_processo" style="float:left;width:10px;height:10px;background-color:#000;border:1px solid #000;margin-top:4px;"></div>
                                                                <div style="float:left;margin-left:5px;font-size:11px;">Sem Situação</div>
                                                            </div>
                                                            <?
															$lista_categorias_parceiro_adv_processo = "|0|";
                                                            if(trim($sysperm['todos_parceiro_adv_processo_tipo'])==1) {
																$qSqlItem = mysql_query("SELECT * FROM parceiro_adv_processo_tipo WHERE stat='1' ORDER BY ordem");
															} else {
																$qSqlItem = mysql_query("SELECT * FROM parceiro_adv_processo_tipo WHERE lista_admin LIKE '%|".$sysusu['id']."|%' AND stat='1' ORDER BY ordem");
															}
                                                            while($rSqlItem = mysql_fetch_array($qSqlItem)) {
                                                                if(trim($lista_categorias_parceiro_adv_processo)=="") {
                                                                    $lista_categorias_parceiro_adv_processo = "|".$rSqlItem['id']."|";
                                                                } else {
                                                                    $lista_categorias_parceiro_adv_processo = $lista_categorias_parceiro_adv_processo."|".$rSqlItem['id']."|";
                                                                }
                                                            ?>
                                                            <div style="width:100%;float:left;margin-top:5px;cursor:pointer;" onclick="filtra_parceiro_sysdashboard('<?=$sysusu['id']?>','<?= $rSqlItem['id'] ?>','1','parceiro_adv_processo','<?= $rSqlItem['cor'] ?>');">
                                                                <input id="check-<?= $rSqlItem['id'] ?>-parceiro_adv_processo" type="checkbox" checked="checked" value="1" style="display:none;" />
                                                                <div id="div-cor-<?= $rSqlItem['id'] ?>-parceiro_adv_processo" style="float:left;width:10px;height:10px;background-color:<?= $rSqlItem['cor'] ?>;border:1px solid <?= $rSqlItem['cor'] ?>;margin-top:4px;"></div>
                                                                <div style="float:left;margin-left:5px;font-size:11px;"><?=$rSqlItem['nome']?></div>
                                                            </div>
                                                            <? } ?>
                                                            
                                                            <input type="hidden" id="lista-categorias-parceiro_adv_processo" value="<?=$lista_categorias_parceiro_adv_processo?>" />
                                                        </div>
            ...
            <script>filtra_parceiro_sysdashboard('<?=$sysusu['id']?>','','0','');</script>
