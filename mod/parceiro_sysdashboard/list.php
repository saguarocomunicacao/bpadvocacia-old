                                ...
                                <div id="preloader-categoria" class="row-fluid">
                                    <div class="span12" style="text-align:center;">
                                        ...
                                        <div style="margin-top:5px;">
                                            ...
                                            <div style="float:left;">aacarregando</div>
                                        </div>
                                ...
                                <div class="row-fluid">
                                    <div class="span12">
                                        <div class="tabbable tabbable-bordered">
											...
											.myClassparceiro_sysagenda_concluida {
											   padding-left: 20px;
											...
											.myClassparceiro_sysagenda_concluida .fc-event-title {
												font-weight:bold;
											   text-decoration:underline;
											}
											...
											.myClassparceiro_adv_processo_agenda_concluida {
											   padding-left: 20px;
											   background-image: url("<?=$link?>template/img/icones_novos/16/stat-1.png");
											   background-repeat: no-repeat;
											   background-position: 2px 50%;
