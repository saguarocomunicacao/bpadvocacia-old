                                                        ...
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms_editar">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;width:100%;">
                                                                    <label>Nome</label>
                                                                    <input value="<?=$row['nome']?>" class="span7" type="text" name="nome" id="nome" />
                                                                </div>
                                                            </div>

                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label>Valor em conta</label>
                                                                    <input value="<?=$row['valor']?>" style="width:150px;" type="text" name="valor" id="valor_editar" />
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="w-box-content">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Nome</th>
                                                                    <th style="width:200px;">Valor em conta</th>
                                                    ...
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;width:100%;">
                                                                    <label>Valor em conta</label>
                                                                    <input value=""  style="width:150px;"type="text" name="valor" id="valor" />
                                                                </div>
                                                            </div>
