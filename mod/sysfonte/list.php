                                    ...
                                    <div class="span12">
                                        <div class="tabbable tabbable-bordered">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a data-toggle="tab" href="#tb1_a">Lista de Itens</a></li>
                                                <li><a data-toggle="tab" href="#tb1_b">Adicionar Novo</a></li>
                                            </ul>
											<script>
                                                        ...
                                                        <div class="w-box-content">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr id="linha-<?=$rSql['id']?>">
                                                                    ...
                                                                    <td><a data-original-title="Editar campo Nome" data-placeholder="Digite um nome" data-placement="right" data-pk="1" data-type="text" id="nome-<?=$rSql['id']?>" href="#"><?=$novo_nome?></a></td>
                                                                    ...
                                                                    <td><a data-original-title="Editar campo Link" data-placeholder="Digite um link" data-placement="right" data-pk="1" data-type="text" id="link-<?=$rSql['id']?>" href="#"><?=$novo_link ?></a></td>
                                                                    <? $novo_family = str_replace("@aspa_simples@","&#039;",$rSql['family']); $novo_family = str_replace("@aspa_dupla@","&quot;",$novo_family); ?>
                                                                    <td><a data-original-title="Editar campo Font Family" data-placeholder="Digite um font family" data-placement="right" data-pk="1" data-type="text" id="family-<?=$rSql['id']?>" href="#"><?=$novo_family?></a></td>
                                                                    <td class="nolink">
                                                                        <div class="btn-group">
                                                    ...
                                                    <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                        ...
                                                        <div class="formSep">
                                                            <div style="float:left;margin-right:10px;">
                                                                ...
                                                                <span class="help-block">Apenas um nome para referência dentro do sistema</span>
                                                            </div>
                                                        </div>
