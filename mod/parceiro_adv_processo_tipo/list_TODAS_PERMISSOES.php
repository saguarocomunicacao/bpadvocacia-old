        <!-- main content -->
                                                            ...
                                                            <div id="tb3_b" class="tab-pane <? if(trim($_REQUEST['var5'])=="permissoes") { ?>active<? } ?>" style="min-height:350px;">
                                                                ...
                                                                <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="formulario_permissoes">
                                                                    ...
                                                                    <div class="formSep">
                                                                        ...
                                                                        <? 
                                                                        $nTipoAuth = mysql_num_rows(mysql_query("SELECT * FROM parceiro_adv_parceiro WHERE idparceiro_adv_processo_tipo='".$_REQUEST['var4']."' AND idsysusu='".$rSqlTipo['id']."' AND auth='1'"));
                                                                        if($nTipoAuth==0) {
                                                                            $nTipoAuth = mysql_num_rows(mysql_query("SELECT * FROM parceiro_adv_parceiro WHERE idparceiro_adv_processo_tipo='".$_REQUEST['var4']."' AND idsysusu='".$rSqlTipo['id']."' AND auth='0'"));
                                                                            if($nTipoAuth==0) {
                                                                                $auth_0 = "checked";
                                                                                $auth_1 = "";
                                                                            } else {
                                                                        ...
                                                                        <div style="float:left;margin-right:10px;padding-bottom:10px;border:1px solid #CCC;padding:3px 5px;margin-bottom:10px;">
                                                                            <label style="font-size:10px;">Botão ?</label>
                                                                            <label class="radio" style="color:#C00;">
                                                                        ...
                                                                        <? 
                                                                        $nTipoVer = mysql_num_rows(mysql_query("SELECT * FROM parceiro_adv_parceiro WHERE idparceiro_adv_processo_tipo='".$_REQUEST['var4']."' AND idsysusu='".$rSqlTipo['id']."' AND ver='1'"));
                                                                        if($nTipoVer==0) {
                                                                            $nTipoVer = mysql_num_rows(mysql_query("SELECT * FROM parceiro_adv_parceiro WHERE idparceiro_adv_processo_tipo='".$_REQUEST['var4']."' AND idsysusu='".$rSqlTipo['id']."' AND ver='0'"));
                                                                            if($nTipoVer==0) {
                                                                                $ver_0 = "checked";
                                                                                $ver_1 = "";
                                                                            } else {
                                                                        ...
                                                                        <? 
                                                                        $nTipoEditar = mysql_num_rows(mysql_query("SELECT * FROM parceiro_adv_parceiro WHERE idparceiro_adv_processo_tipo='".$_REQUEST['var4']."' AND idsysusu='".$rSqlTipo['id']."' AND editar='1'"));
                                                                        if($nTipoEditar==0) {
                                                                            $nTipoEditar = mysql_num_rows(mysql_query("SELECT * FROM parceiro_adv_parceiro WHERE idparceiro_adv_processo_tipo='".$_REQUEST['var4']."' AND idsysusu='".$rSqlTipo['id']."' AND editar='0'"));
                                                                            if($nTipoEditar==0) {
                                                                                $editar_0 = "checked";
                                                                                $editar_1 = "";
                                                                            } else {
                                                                        ...
                                                                        <? 
                                                                        $nTipoExcluir = mysql_num_rows(mysql_query("SELECT * FROM parceiro_adv_parceiro WHERE idparceiro_adv_processo_tipo='".$_REQUEST['var4']."' AND idsysusu='".$rSqlTipo['id']."' AND excluir='1'"));
                                                                        if($nTipoExcluir==0) {
                                                                            $nTipoExcluir = mysql_num_rows(mysql_query("SELECT * FROM parceiro_adv_parceiro WHERE idparceiro_adv_processo_tipo='".$_REQUEST['var4']."' AND idsysusu='".$rSqlTipo['id']."' AND excluir='0'"));
                                                                            if($nTipoExcluir==0) {
                                                                                $excluir_0 = "checked";
                                                                                $excluir_1 = "";
                                                                            } else {
                                                                        ...
                                                                        <? 
                                                                        $nTipoDespublicar = mysql_num_rows(mysql_query("SELECT * FROM parceiro_adv_parceiro WHERE idparceiro_adv_processo_tipo='".$_REQUEST['var4']."' AND idsysusu='".$rSqlTipo['id']."' AND despublicar='1'"));
                                                                        if($nTipoDespublicar==0) {
                                                                            $nTipoDespublicar = mysql_num_rows(mysql_query("SELECT * FROM parceiro_adv_parceiro WHERE idparceiro_adv_processo_tipo='".$_REQUEST['var4']."' AND idsysusu='".$rSqlTipo['id']."' AND despublicar='0'"));
                                                                            if($nTipoDespublicar==0) {
                                                                        ...
                                                                        <? 
                                                                        $nTipoPublicar = mysql_num_rows(mysql_query("SELECT * FROM parceiro_adv_parceiro WHERE idparceiro_adv_processo_tipo='".$_REQUEST['var4']."' AND idsysusu='".$rSqlTipo['id']."' AND publicar='1'"));
                                                                        if($nTipoPublicar==0) {
                                                                            $nTipoPublicar = mysql_num_rows(mysql_query("SELECT * FROM parceiro_adv_parceiro WHERE idparceiro_adv_processo_tipo='".$_REQUEST['var4']."' AND idsysusu='".$rSqlTipo['id']."' AND publicar='0'"));
                                                                            if($nTipoPublicar==0) {
                                                                                $publicar_0 = "checked";
                                                                                $publicar_1 = "";
                                                                            } else {
                                                            ...
                                                            <div class="pull-left">
                                                                <div class="toggle-group">
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        ...
                                                                        <li>-------------------------</li>
                                                                        <li><a href="javascript:void(0);" onclick="clonar_selecionados();"><div style="background-color:#090;width:20px;float:left;height:20px;margin-left:-12px;"></div> &nbsp;CLONAR SELECIONADOS</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="w-box-content">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                while($rSql = mysql_fetch_array($qSql)) {
																	 ...
																	 if($rSql['ordem']<10) {
																		 $ordem_set = "0".$rSql['ordem']."";
																	 } else {
																		 $ordem_set = "".$rSql['ordem']."";
																	 }
                                                                ?>
                                                                <script>
																$(function(){
                                                                ...
                                                                <tr id="linha-<?=$rSql['id']?>">
                                                                    <td style="vertical-align:middle;" class="nolink"><input type="checkbox" name="msg_sel[]" class="select_msg" onclick="seleciona_linha_intimacao('<?=$rSql['id']?>');" value="<?=$rSql['id']?>" /></td>
                                                                    <td style="vertical-align:middle;"><?=$ordem_set?></td>
            ...
            <script>
			function clonar_selecionados() {
				$("#acaoForm_lista").val("clonar");
				$("#lista_form").submit();
			}
