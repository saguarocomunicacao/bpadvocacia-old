                                    ...
                                    <div class="span12">
                                        <div class="tabbable tabbable-bordered">
                                            <ul class="nav nav-tabs">
                                                ...
                                                <? if(trim($sysperm['inserir_'.$mod.'_item'])==1||trim($sysperm['editar_'.$mod.'_item'])==1||trim($sysperm['excluir_'.$mod.'_item'])==1) { ?><li <? if(trim($_REQUEST['var3'])=="") { ?>class="active"<? } ?>><a data-toggle="tab" href="#tb1_lista">Lista de Itens</a></li><? } ?>
                                                <? if(trim($sysperm['inserir_'.$mod.'_item'])==1) { ?><li><a data-toggle="tab" href="#tb1_novo">Adicionar Novo</a></li><? } ?>
                                                <? if(trim($sysperm['inserir_'.$mod.'_categoria'])==1||trim($sysperm['editar_'.$mod.'_categoria'])==1||trim($sysperm['excluir_'.$mod.'_categoria'])==1) { ?><li><a data-toggle="tab" href="#tb1_categorias">Categorias</a></li><? } ?>
                                                <? if(trim($sysperm['descricao_'.$mod.'_item'])==1) { ?><li><a data-toggle="tab" href="#tb1_config">Descrição</a></li><? } ?>
                                                <? if(trim($row_estrutura['seo'])==1) { ?><? if(trim($sysperm['seo_'.$mod.'_item'])==1) { ?><li><a data-toggle="tab" href="#tb1_e"><? if(trim($row_estrutura['seo_label'])=="") { echo "Configurações de SEO"; } else { echo $row_estrutura['seo_label']; } ?></a></li><? } ?><? } ?>
											...
											beoro_select_row = {
												init: function() {
													$('.select_msgs_item').click(function () {
                                                        ...
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                ...
                                                                <select name="ordem" id="ordem" style="width:70px;">
                                                                    <?
                                                                    $nordem = mysql_num_rows(mysql_query("SELECT * FROM ".$linguagem_set."".$mod."_item"));
                                                                    if($nordem==0) {
                                                                    ?>
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    ...
                                                                    <select name="idprojeto_categoria" id="idprojeto_categoria">
                                                                        <option value="">---</option>
                                                                        <?
                                                                        $qSqlItem = mysql_query("SELECT * FROM ".$linguagem_set."".$mod."_categoria ORDER BY ordem");
                                                                        while($rSqlItem = mysql_fetch_array($qSqlItem)) {
                                                                        ?>
                                                                        <option value="<?= $rSqlItem['id'] ?>" <? if($rSqlItem['id']==$row['idprojeto_categoria']) { echo "selected"; } ?>><?=$rSqlItem['nome']?></option>
                                                                        <? } ?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="formSep">
                                                                ...
                                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                    ...
                                                                    <? if(trim($row['imagem_capa'])=="") { ?>
                                                                    <img src="<?=$link?>template/img/dummy_50x50.gif" alt="" >
                                                                    <? } else { ?>
                                                                    <a class="img_action_zoom" href="<?=$link?>files/<?=$linguagem_set?><?=$mod?>_item/<?=$row['numeroUnico']?>/<?=$row['imagem_capa']?>"><img style="width:50px;" id="arquivo-atual-imagem_capa" src="<?=$link?>files/<?=$linguagem_set?><?=$mod?>_item/<?=$row['numeroUnico']?>/<?=$row['imagem_capa']?>" alt=""></a>
                                                                    <? } ?>
                                                                    </div>
                                                                    ...
                                                                    <span class="btn btn-small btn-file">
                                                                        ...
                                                                        <input name="imagem_capa" type="file">
                                                                    </span>
                                                                    ...
                                                                    <a href="javascript:void(0);" onclick="remover_imagem('<?=$row['id']?>','<?=$mod?>_item','imagem_capa');" class="btn btn-small" data-dismiss="fileupload">Remover</a>
                                                                    <? } ?>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="formSep">
                                                                ...
                                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                    <div class="fileupload-new thumbnail">
                                                                    <? if(trim($row['imagem_interna'])=="") { ?>
                                                                    <img src="<?=$link?>template/img/dummy_50x50.gif" alt="" >
                                                                    <? } else { ?>
                                                                    <a class="img_action_zoom" href="<?=$link?>files/<?=$linguagem_set?><?=$mod?>_item/<?=$row['numeroUnico']?>/<?=$row['imagem_interna']?>"><img style="width:50px;" id="arquivo-atual-imagem_interna" src="<?=$link?>files/<?=$linguagem_set?><?=$mod?>_item/<?=$row['numeroUnico']?>/<?=$row['imagem_interna']?>" alt=""></a>
                                                                    <? } ?>
                                                                    </div>
                                                                    <div class="fileupload-preview fileupload-exists thumbnail" style="width: 50px; height: 50px;"></div>
                                                                    <? if(trim($row['imagem_interna'])=="") { ?>
                                                                    ...
                                                                    <a href="javascript:void(0);" onclick="remover_imagem('<?=$row['id']?>','<?=$mod?>_item','imagem_interna');" class="btn btn-small" data-dismiss="fileupload">Remover</a>
                                                                    <? } ?>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="formSep">
                                                                <? if(trim($sysperm['editar_'.$mod.'_item'])==1) { ?>
                                                ...
                                                <div id="tb1_lista" class="tab-pane <? if(trim($_REQUEST['var3'])=="") { ?>active<? } ?>">
                                                    <div class="w-box w-box">
                                                        ...
                                                        <div class="w-box-content">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    <th style="width:20px;" class="table_checkbox"><input type="checkbox" name="select_msgs" class="select_msgs_item ptip_se" title="Selecionar todos" data-tableid="dt_basic" /></th>
                                                            ...
                                                            <tbody>
                                                                <?
                                                                $qSql = mysql_query("SELECT * FROM ".$linguagem_set."".$mod."_item ORDER BY ordem");
																		...
																		validate: function(value) {
																		   if($.trim(value) == '') { 
																		    return 'Este campo é obrigatório';
																			   ...
																			   salva_campo_tabela('nome','<?=$rSql['id']?>','<?=$mod?>_item',value);
																		   }
																		}
																	});
                                                                ...
                                                                <tr id="linha-<?=$rSql['id']?>">
                                                                    ...
                                                                    <td style="width:60px">
                                                                        ...
                                                                        <? } else { ?>
                                                                        <a class="img_action_zoom thumbnail" href="<?=$link?>files/<?=$linguagem_set?><?=$mod?>_item/<?=$rSql['numeroUnico']?>/<?=$rSql['imagem_capa']?>"><img style="width:50px" src="<?=$link?>files/<?=$linguagem_set?><?=$mod?>_item/<?=$rSql['numeroUnico']?>/<?=$rSql['imagem_capa']?>" alt="<?=$rSql['nome']?>"/></a>
                                                                        <? } ?>
                                                                    </td>
                                                                    <? $item = mysql_fetch_array(mysql_query("SELECT * FROM ".$linguagem_set."".$mod."_categoria WHERE id='".$rSql['idprojeto_categoria']."'")); ?>
                                                                    ...
                                                                    <td style="vertical-align:middle;" class="nolink">
                                                                        ...
                                                                        <? if(trim($rSql['destaque'])=="1") { ?>
																			<? if(trim($sysperm['editar_'.$mod.'_item'])==1) { ?>
                                                                            <a href="javascript:void(0);" onclick="muda_destaque('<?=$mod?>_item','<?=$rSql['id']?>','0');" class="btn-mini ptip_se" title="Retirar de destaque"><img src="<?=$link?>template/img/icones_novos/16/destaque-1.png" /></a>
                                                                            <? } else { ?>
                                                                        ...
                                                                        <? } else { ?>
																			<? if(trim($sysperm['editar_'.$mod.'_item'])==1) { ?>
                                                                            <a href="javascript:void(0);" onclick="muda_destaque('<?=$mod?>_item','<?=$rSql['id']?>','1');" class="btn-mini ptip_se" title="Colocar como destaque"><img src="<?=$link?>template/img/icones_novos/16/destaque-0.png" /></a>
                                                                            <? } else { ?>
                                                                            ...
                                                                            <? } ?>
                                                                        <? } ?>
                                                                        <? if(trim($sysperm['editar_'.$mod.'_item'])==1) { ?><a href="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>/editar/<?=$rSql['id']?>/" class="btn-mini ptip_se" title="Editar"><img src="<?=$link?>template/img/icones_novos/16/editar.png" /></a><? } ?>
                                                                        <? if(trim($sysperm['excluir_'.$mod.'_item'])==1) { ?><a href="javascript:void(0);" onclick="remover_item_tabela('<?=$rSql['id']?>','<?=$mod?>_item','NAO','');" class="btn-mini ptip_se" title="Remover"><img src="<?=$link?>template/img/icones_novos/16/remover-x.png" /></a><? } ?>
                                                                        <? if(trim($rSql['stat'])=="1") { ?>
																			<? if(trim($sysperm['despublicar_'.$mod.'_item'])==1) { ?>
                                                                            <a href="javascript:void(0);" onclick="muda_stat('<?=$mod?>_item','<?=$rSql['id']?>','0');" class="btn-mini ptip_se" title="Despublicar"><img src="<?=$link?>template/img/icones_novos/16/stat-1.png" /></a>
                                                                            <? } else { ?>
                                                                            ...
                                                                            <? } ?>
                                                                        <? } else { ?>
																			<? if(trim($sysperm['publicar_'.$mod.'_item'])==1) { ?>
                                                                            <a href="javascript:void(0);" onclick="muda_stat('<?=$mod?>_item','<?=$rSql['id']?>','1');" class="btn-mini ptip_se" title="Publicar"><img src="<?=$link?>template/img/icones_novos/16/stat-0.png" /></a>
                                                                            <? } else { ?>
                                                    ...
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label class="req">Nome</label>
                                                                    <input value="" style="width:350px;" onkeyup="cria_titulo_e_url('nome','titulo_seo','titulo_seo_google','url_amigavel','url_amigavel_google','Nome','titulo_seo_contador','55');" type="text" name="nome" id="nome" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="formSep">
                                                                <label class="req">Imagem de Capa</label>
                                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                    <div class="fileupload-new thumbnail" style="width: 50px; height: 50px;"><img src="<?=$link?>template/img/dummy_50x50.gif" alt="" ></div>
                                                                    <div class="fileupload-preview fileupload-exists thumbnail" style="width: 50px; height: 50px;"></div>
                                                                    <span class="btn btn-small btn-file"><span class="fileupload-new">Selecionar arquivo</span><span class="fileupload-exists">Alterar</span><input name="imagem_capa" type="file"></span>
                                                                    <a href="#" class="btn btn-small fileupload-exists" data-dismiss="fileupload">Remover</a>
                                                                </div>
                                                            </div>
                
                                                            <div class="formSep">
                                                                <label class="req">Imagem Interna</label>
                                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                    <div class="fileupload-new thumbnail" style="width: 50px; height: 50px;"><img src="<?=$link?>template/img/dummy_50x50.gif" alt="" ></div>
                                                                    <div class="fileupload-preview fileupload-exists thumbnail" style="width: 50px; height: 50px;"></div>
                                                                    <span class="btn btn-small btn-file"><span class="fileupload-new">Selecionar arquivo</span><span class="fileupload-exists">Alterar</span><input name="imagem_interna" type="file"></span>
                                                                    <a href="#" class="btn btn-small fileupload-exists" data-dismiss="fileupload">Remover</a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div style="float:left;margin-top:10px;width:100%;padding-bottom:10px;border-top:1px dashed #CCCCCC;padding-top:10px;">
                                                                ...
                                                                <div id="lista_categoria_itens" style="width:100%;float:left;">
																	<div id="preloader" style="width:100%; height:100%; background-color:#F8F8F8;padding-top:10px;padding-bottom:10px;display:none;" ><table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%"><tr><td align="center" valign="middle"><img src="<?=$link?>template/img/preloader.gif" /></td></tr></table></div>
