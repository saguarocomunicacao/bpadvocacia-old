                                                    ...
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep" id="galeria-video_editar" style="margin-right:10px;width:100%;margin-bottom:50px;float:left;margin-top:20px;">
                                                                <? $numeroUnicoGet = $numeroUnicoGerado; include("./acoes/portfolio/lista_video.php"); ?>
                                                            </div>
                                                            <? } ?>
                                                            ...
                                                            <script type="text/javascript" >
                                                                $(function(){
                                                                    new AjaxUpload($('#upload-arquivo'), {
                                                                        action: '<?=$link?>acoes/portfolio/drop-arquivo.php?numeroUnico_upload_arquivo=<?=$numeroUnicoGerado?>',
																		name: 'file',
                                                            ...
                                                            {
                                                                var uploadURL ="<?=$link?>acoes/portfolio/drop-arquivo.php"; //Upload URL
                                                            ...
                                                            <div id="galeria-fotos" class="formSep">
                                                            	<? $numeroUnicoGet = $numeroUnicoGerado; include("./acoes/portfolio/lista_galeria.php"); ?>
                                                            </div>
                                                            <? } ?>
                                                        ...
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                ...
                                                                <div style="margin-right:10px;width:100%;float:left;">
                                                                    ...
                                                                    <div style="float:left;margin-right:10px;margin-top:24px;">
                                                                        <button type="button" onclick="javascript:adicionar_video('<?=$mod?>','');" class="btn btn-primary">Adicionar Vídeo</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <script type="text/javascript" >
                                                                $(function(){
                                                                    new AjaxUpload($('#upload-arquivo'), {
                                                                        action: '<?=$link?>acoes/portfolio/drop-arquivo.php?numeroUnicoS=<?=$numeroUnicoGerado?>',
																		name: 'file',
                                                                        onSubmit: function(file, ext){
                                                                        },
                                                                        onComplete: function(file, response){
