					...
					if(trim($_POST['acaoForm'])=="publicar") {
						...
						if(trim($_POST['acaoForm'])=="despublicar") {
							...
							if(trim($_POST['acaoForm'])=="config_seo") {
								...
								if(trim($_POST['idportfolio_categoria'])=="") { $_POST['idportfolio_categoria']=0; } else { $_POST['idportfolio_categoria']=1; }
								...
								if($nEstrutura==0) { 
									$insert = mysql_query("INSERT INTO ".$mod."_estrutura (
																						  ...
																						  '".$_POST['idportfolio_categoria_label']."',
																						  ...
																						  '".$_POST['idportfolio_categoria_info']."',
									...
									$update = mysql_query("UPDATE ".$mod."_estrutura SET 
																						 ...
																						 idportfolio_categoria='".$_POST['idportfolio_categoria']."',
																						 ...
																						 idportfolio_categoria_label='".$_POST['idportfolio_categoria_label']."',
																						 ...
																						 idportfolio_categoria_info='".$_POST['idportfolio_categoria_info']."',
