                                        ...
                                        <div class="tabbable tabbable-bordered">
                                                    ...
                                                    if($('#dt_basic').length) {
                                                        $('#dt_basic').dataTable({
															...
															"aoColumns": [
																...
																{ "sType": "string" },
																<? if(trim($row_estrutura['empresa'])==1) { ?>{ "sType": "string" },<? } ?>
																{ "bSortable": false }
															]
                                                        });
                                                    }
											...
											beoro_switchButtons = {
												init: function() {
													...
													if($('#empresa_estrutura').length) { $("#empresa_estrutura").iButton(); }
                                                ...
                                                <div id="tb1_editar" class="tab-pane active">
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <? if(trim($row_estrutura['empresa'])==1) { ?>
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label><? if(trim($row_estrutura['empresa_label'])=="") { echo "Empresa"; } else { echo $row_estrutura['empresa_label']; } ?></label>
                                                                    <input value="<?=$row['empresa']?>" style="width:350px;" type="text" name="empresa" id="empresa" />
                                                                </div>
                                                                <? if(trim($row_estrutura['empresa_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;"><?=$row_estrutura['empresa_info']?></span><? } ?>
                                                            </div>
                                                            <? } ?>
                                                        ...
                                                        <div class="w-box-content">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <? if(trim($row_estrutura['empresa'])==1) { ?>
                                                                    <th><? if(trim($row_estrutura['empresa_label'])=="") { echo "Empresa"; } else { echo $row_estrutura['empresa_label']; } ?></th>
                                                                    <? } ?>
                                                            ...
                                                            <tbody>
																...
																$(function(){
																	...
																	<? if(trim($row_estrutura['empresa'])==1) { ?>
																	$('#empresa-<?=$rSql['id']?>').editable({
																		validate: function(value) {
																		   if($.trim(value) == '') { 
																		    return 'Este campo é obrigatório';
																		   } else {
																			   salva_campo_tabela('empresa','<?=$rSql['id']?>','<?=$mod?>',value);
																		   }
																		}
																	});
																	<? } ?>
                                                                ...
                                                                <tr id="linha-<?=$rSql['id']?>">
                                                                    ...
                                                                    <? } ?>
                                                                    <td style="vertical-align:middle;"><a data-original-title="Editar campo <th><? if(trim($row_estrutura['nome_label'])=="") { echo "Nome"; } else { echo $row_estrutura['nome_label']; } ?></th>" data-placeholder="Digite um <th><? if(trim($row_estrutura['nome_label'])=="") { echo "Nome"; } else { echo $row_estrutura['nome_label']; } ?></th>" data-placement="right" data-pk="1" data-type="text" id="nome-<?=$rSql['id']?>" href="#"><?=$rSql['nome']?></a></td>
                                                                    <? if(trim($row_estrutura['empresa'])==1) { ?>
                                                                    <td style="vertical-align:middle;"><a data-original-title="Editar campo Empresa" data-placeholder="Digite um empresa" data-placement="right" data-pk="1" data-type="text" id="empresa-<?=$rSql['id']?>" href="#"><?=$rSql['empresa']?></a></td>
                                                                    <? } ?>
                                                    ...
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;width:100%;">
                                                                    <label><? if(trim($row_estrutura['empresa_label'])=="") { echo "Empresa"; } else { echo $row_estrutura['empresa_label']; } ?></label>
                                                                    <input value="" class="span7" type="text" name="empresa" id="empresa" />
                                                                </div>
                                                                <? if(trim($row_estrutura['empresa_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;"><?=$row_estrutura['empresa_info']?></span><? } ?>
                                                            </div>
                                                            <? } ?>
                                                ...
                                                <div id="tb1_estrutura" class="tab-pane">
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label class="req">Campo 'Empresa'</label>
                                                                    <input value="<?=$row_estrutura['empresa_label']?>"  style="width:350px;" type="text" name="empresa_label" id="empresa_label" />
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                                    <label>Ativo ?</label>
                                                                    <input type="checkbox" name="empresa" id="empresa_estrutura" <? if(trim($row_estrutura['empresa'])==1) { echo " checked"; } ?> class="empresa_estrutura {labelOn: 'SIM', labelOff: 'NÃO'}" />
                                                                </div>
                                                                <div style="float:left;margin-right:10px;width:100%;">
                                                                    <label>Informações Extras</label>
                                                                    <input value="<?=$row_estrutura['empresa_info']?>"class="span7" type="text" name="empresa_info" id="empresa_info" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    ...
                                                                    <select name="campo_ordem_1" id="campo_ordem_1">
                                                                        ...
                                                                        <option value='empresa' <? if($row_estrutura['campo_ordem_1']=="empresa") { echo "selected"; } ?>><? if(trim($row_estrutura['empresa_label'])=="") { echo "Empresa"; } else { echo $row_estrutura['empresa_label']; } ?></option>
                                                                    </select>
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    ...
                                                                    <select name="campo_ordem_2" id="campo_ordem_2">
                                                                        ...
                                                                        <option value='empresa' <? if($row_estrutura['campo_ordem_2']=="empresa") { echo "selected"; } ?>><? if(trim($row_estrutura['empresa_label'])=="") { echo "Empresa"; } else { echo $row_estrutura['empresa_label']; } ?></option>
                                                                    </select>
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
