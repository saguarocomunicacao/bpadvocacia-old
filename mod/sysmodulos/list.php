                                                                ...
                                                                <div class="tab-content">
                                                                    ...
                                                                    <div id="tb3_a" class="tab-pane active" style="min-height:350px;">
                                                                        ...
                                                                        <div class="formSep">
                                                                            ...
                                                                            <div style="float:left;margin-right:10px;padding-bottom:10px;"  class="span2">
                                                                                <label><? if(trim($row_estrutura['valor_mensalidade_label'])=="") { echo "Mensalidade"; } else { echo $row_estrutura['valor_mensalidade_label']; } ?></label>
                                                                                <div class="input-prepend">
                                                        ...
                                                        <div class="w-box-content">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <? } ?>
                                                                    <? if(trim($row_estrutura['valor_mensalidade'])==1) { ?>
                                                                    <th style="width:100px;"><? if(trim($row_estrutura['valor_mensalidade_label'])=="") { echo "Mensalidade"; } else { echo $row_estrutura['valor_mensalidade_label']; } ?></th>
                                                                    <? } ?>
