                                    ...
                                    <div class="span12">
                                        <div class="tabbable tabbable-bordered">
                                            <ul class="nav nav-tabs">
                                                <? if(trim($sysperm['visualizar_'.$mod.''])==1||trim($sysperm['inserir_'.$mod.''])==1) { ?><li class="active"><a data-toggle="tab" href="#tb1_a">Visualizando Chamado #<?=$row['idchamado']?></a></li><? } ?>
                                                <? if(trim($sysperm['visualizar_'.$mod.''])==1||trim($sysperm['inserir_'.$mod.''])==1) { ?><li><a data-toggle="tab" href="#tb1_b">Lista de Chamados</a></li><? } ?>
                                                ...
                                                <div id="tb1_a" class="tab-pane active">
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>/" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <? if(trim($sysperm['inserir_'.$mod.''])==1) { ?>
                                                                ...
                                                                <div id="lista_categoria_itens" style="width:100%;float:left;">
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th>Assunto</th>
                                                                            <th style="width:200px;">AAnexo</th>
