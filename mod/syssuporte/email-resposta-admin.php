...
$msg .= "        	<table width='100%'>";
$msg .= "                <tr>";
$msg .= "                	<td class='CinzaM'><strong>".$usuario_chamado['nome'].",</strong></td>";
$msg .= "                </tr>";
$msg .= "            </table>";
$msg .= "    	</td>";
$msg .= "    </tr>";
...
$msg .= "                <tr>";
$msg .= "                	<td class='CinzaM'>
							A equipe da TAGX respondeu seu chamado, verifique abaixo os detalhes da resposta.
							<br><br>
							<strong>Data da resposta:</strong> ".$data."<br>
							<strong>Assunto:</strong> ".$_POST['nome']."<br>
							<strong>Detalhes da resposta:</strong> ".$_POST['texto']."<br>
							<br><br>
							</td>";
$msg .= "                </tr>";
$msg .= "            </table>";
...
$msg2 .= "                	<td class='CinzaM'>
							O sistema enviou um email para ele informando que o chamado foi respondido.
							<br><br>
...
$nomeCliente = "".$usuario_chamado['nome']."";
$emailCliente = "".$usuario_chamado['email']."";
