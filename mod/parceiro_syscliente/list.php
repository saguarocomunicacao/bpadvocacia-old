                                                ...
                                                basic: function() {
                                                    if($('#example').length) {
														$('#example').dataTable({
															...
															"serverSide": true,
															"iDisplayLength": 50,
															"ajax": "<?=$link?>acoes/parceiro_syscliente/tabela.php?var1=<?=$_REQUEST['var1']?>&var2=<?=$_REQUEST['var2']?>&var3=<?=$_REQUEST['var3']?>&var4=<?=$_REQUEST['var4']?>&var5=<?=$_REQUEST['var5']?>&sysusuS=<?=$sysusu['id']?>",
                                                            ...
                                                            <div class="tabbable tabs-left tabbable-bordered">
                                                                ...
                                                                <div class="tab-content">
                                                                    ...
                                                                    <div id="tb3_j" class="tab-pane" style="min-height:350px;">
                                                                        <div class="formSep">
                                                                            <div id="lista_parceiro_syscliente_parceiro_adv_processo" style="width:100%;float:left;">
                                                                                <? $sufixoGet = ""; $idparceiro_sysclienteGet = $_REQUEST['var4']; include("./acoes/parceiro_adv_processo/lista_parceiro_syscliente_parceiro_adv_processo.php"); ?>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div id="tb3_d" class="tab-pane" style="min-height:350px;">
                                                                        ...
                                                                        <div style="float:left;margin-top:10px;width:100%;padding-bottom:10px;border-top:1px dashed #CCCCCC;padding-top:10px;">
                                                                            <div id="lista_parceiro_syscliente_telefones" style="width:100%;float:left;">
                                                                                <? $sufixoGet = ""; $numeroUnicoGet = $numeroUnicoGerado; include("./acoes/parceiro_syscliente/lista_".$mod."_telefones.php"); ?>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div style="float:left;margin-top:10px;width:100%;padding-bottom:10px;border-top:1px dashed #CCCCCC;padding-top:10px;">
                                                                            <div id="lista_parceiro_syscliente_emails" style="width:100%;float:left;">
                                                                                <? $sufixoGet = ""; $numeroUnicoGet = $numeroUnicoGerado; include("./acoes/parceiro_syscliente/lista_".$mod."_emails.php"); ?>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div id="tb3_e" class="tab-pane" style="min-height:350px;">
                                                                        ...
                                                                        <div style="float:left;margin-top:10px;width:100%;padding-bottom:10px;border-top:1px dashed #CCCCCC;padding-top:10px;">
                                                                            <div id="lista_parceiro_syscliente_endereco" style="width:100%;float:left;">
                                                                                <? $sufixoGet = ""; $numeroUnicoGet = $numeroUnicoGerado; include("./acoes/parceiro_syscliente/lista_".$mod."_endereco.php"); ?>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div id="tb3_f" class="tab-pane" style="min-height:350px;">
                                                                        ...
                                                                        <div style="float:left;margin-top:10px;width:100%;padding-bottom:10px;border-top:1px dashed #CCCCCC;padding-top:10px;">
                                                                            ...
                                                                            <div id="lista_parceiro_syscliente_redes" style="width:100%;float:left;">
                                                                                <? $sufixoGet = ""; $numeroUnicoGet = $numeroUnicoGerado; include("./acoes/parceiro_syscliente/lista_".$mod."_redes.php"); ?>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div id="tb3_i" class="tab-pane" style="min-height:350px;">
                                                                        ...
                                                                        <div style="float:left;margin-top:10px;width:100%;padding-bottom:10px;border-top:1px dashed #CCCCCC;padding-top:10px;">
                                                                            <div id="lista_parceiro_syscliente_banco" style="width:100%;float:left;">
                                                                                <? $sufixoGet = ""; $numeroUnicoGet = $numeroUnicoGerado; include("./acoes/parceiro_syscliente/lista_".$mod."_banco.php"); ?>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div id="tb3_k" class="tab-pane " style="min-height:350px;">
																		<? $rSqlClassificacao = mysql_fetch_array(mysql_query("SELECT * FROM ".$mod."_classificacao_set WHERE idparceiro_syscliente='".$row['id']."'")); ?>
                                                                        <script>
																		function salvar_classificacao() {

																			$.ajax({
																				url: ""+linkSite+"acoes/parceiro_syscliente/salva-classificacao.php",
																				type: "GET",
																				data: "modS=<?=$mod?>&idparceiro_sysclienteS=<?=$row['id']?><? $qSqlItem = mysql_query("SELECT * FROM ".$mod."_classificacao WHERE stat='1' ORDER BY ordem"); while($rSqlItem = mysql_fetch_array($qSqlItem)) { ?>&classificacao_<?=$rSqlItem['numeroUnico']?>S="+$('#classificacao_<?=$rSqlItem['numeroUnico']?>').val()+"<? } ?>",
																				//dataType: "html",
                                                ...
                                                <div id="tb1_contratos" class="tab-pane">
                                                    <div class="w-box w-box">
                                                        ...
                                                        <div class="w-box-content">
                                                            ...
                                                            <tbody>
                                                                <?
                                                                $qSql = mysql_query("SELECT * FROM syscontrato WHERE idparceiro_syscliente='".$_REQUEST['var4']."' ORDER BY data DESC");
                                                    ...
                                                    <div class="w-box w-box">
                                                        ...
                                                        <div class="w-box-content">
                                                            ...
                                                            <tbody>
																...
																$qSqlCat = mysql_query("SELECT * FROM syscontrato WHERE idparceiro_syscliente='".$_REQUEST['var4']."' AND aceito='1'");
