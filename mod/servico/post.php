					...
					if(trim($_POST['acaoForm'])=="publicar") {
						...
						if(trim($_POST['acaoForm'])=="despublicar") {
							...
							if(trim($_POST['acaoForm'])=="config_seo") {
								...
								if(trim($_POST['idservico_categoria'])=="") { $_POST['idservico_categoria']=0; } else { $_POST['idservico_categoria']=1; }
								...
								if($nEstrutura==0) { 
									$insert = mysql_query("INSERT INTO ".$mod."_estrutura (
																						  ...
																						  '".$_POST['idservico_categoria_label']."',
																						  '".$_POST['ordem_label']."',
																						  '".$_POST['nome_label']."',
																						  ...
																						  '".$_POST['idservico_categoria_info']."',
																						  '".$_POST['ordem_info']."',
																						  '".$_POST['nome_info']."',
																						  '".$_POST['destaque_info']."',
																						  '".$_POST['imagem_info']."',
									...
									$update = mysql_query("UPDATE ".$mod."_estrutura SET 
																						 ...
																						 idservico_categoria='".$_POST['idservico_categoria']."',
																						 ordem='".$_POST['ordem']."',
																						 nome='".$_POST['nome']."',
																						 ...
																						 idservico_categoria_label='".$_POST['idservico_categoria_label']."',
																						 ...
																						 idservico_categoria_info='".$_POST['idservico_categoria_info']."',
