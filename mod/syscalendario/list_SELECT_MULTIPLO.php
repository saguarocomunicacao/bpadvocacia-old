                                                ...
                                                <div id="tb1_lista" class="tab-pane <? if(trim($_REQUEST['var3'])=="") { ?>active<? } ?>">
                                                    ...
                                                    <div class="span4">
                                                        <div class="w-box w-box">
                                                            <div class="w-box-header">Filtros</div>
                                                            <div class="w-box-content">

                                                                <script>
																$(document).ready(function() {
																	$('#filtra_sysusu_itens').multiSelect({
																		selectableHeader: '<div class="search-header"><input type="text" class="span12" id="ms-search" autocomplete="off" placeholder="Digite aqui sua busca"></div>',
																		selectionHeader: "<div class='search-selected'></div>",
																		afterSelect: function(values){
																			$('#filtra_sysusu').val(""+$('#filtra_sysusu').val()+'|'+values+'|');
																		},
																		afterDeselect: function(values){
																			$('#filtra_sysusu').val($('#filtra_sysusu').val().replace('|'+values+'|',''));
																		}
																	});
																});
			...
			$("#preloader-categoria").hide();
                                                                ...
                                                                <div style="width:100%;float:left;">
                                                                    <div style="float:left;width:100%;margin-bottom:10px;">
                                                                        <label>Responsáveis</label>
                                                                        <select id="filtra_sysusu_itens" multiple="multiple" >
                                                                            <?
                                                                        ...
                                                                        <input value="<?=$row['filtra_sysusu']?>" style="width:350px;" type="hidden" name="filtra_sysusu" id="filtra_sysusu"  />
                                                                    </div>
                                                                    <span class="help-block" style="width:100%;float:left;">Selecione os usuários que deseja filtrar as respectivas tarefas</span>
                                                                </div>

                                                                <div style="width:100%;float:left;">
                                                                    <div style="float:left;width:100%;">
                                                                        <label>Palavra-chave</label>
                                                                        <input value="" style="width:100%;"  type="text" name="busca_palavra_chave" id="busca_palavra_chave"  />
                                                                    </div>
                                                                    <span class="help-block" style="width:100%;float:left;">Digite uma palavra-chave para realizar uma pesquisa</span>
                                                                </div>

                                                                <div class="formSep" style="width:100%;float:left;">
                                                                    <button type="button" style="margin-left:-20px;" onclick="javascript:filtra_syscalendario_novo('<?=$sysusu['id']?>');" class="btn btn-success">Realizar Filtro</button>
                                                                </div>
                                                    ...
                                                    <div class="span<?=$spanSet?>" style="margin-left:20px;">
