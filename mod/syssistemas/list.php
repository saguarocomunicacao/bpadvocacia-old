                                        ...
                                        <div class="tabbable tabbable-bordered">
											...
											<script>
                                              $(document).ready(function() {
												...
												$("#item_valor").maskMoney({ decimal:",", thousands:".", allowZero:true});
												$("#item_valor_mensalidade").maskMoney({ decimal:",", thousands:".", allowZero:true});
											...
											beoro_wysiwg = {
												init: function() {
													...
													<? } ?>
													<? if(trim($row_estrutura['info_sistema'])==1) { ?>
													if($('#info_sistema').length) { 
														CKEDITOR.replace( 'info_sistema', {
															toolbar: 'Standard'
														});
													}
													<? } ?>
											...
											beoro_switchButtons = {
												init: function() {
													...
													if($('#info_sistema_estrutura').length) { $("#info_sistema_estrutura").iButton(); }
													...
													if($('#syssistemas_set').length) { $("#syssistemas_set").iButton(); }
                                                        ...
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>/" target="_self" ENCTYPE="multipart/form-data" id="formulario">
                                                            ...
                                                            <div class="tabbable tabs-left tabbable-bordered">
                                                                <ul class="nav nav-tabs">
                                                                    ...
                                                                    <li><a data-toggle="tab" href="#tb3_b">Módulos Relacionados</a></li>

                                                                    <? if(trim($row_estrutura['chamada'])==1||trim($row_estrutura['texto'])==1||trim($row_estrutura['info_sistema'])==1||trim($row_estrutura['info_tecnica'])==1||trim($row_estrutura['garantia'])==1||trim($row_estrutura['manual'])==1) { ?>
                                                                    <li><a data-toggle="tab" href="#tb3_c">Informações</a></li>
                                                                    <? } ?>
                                                                    <? if(trim($row_estrutura['lista_relacionado'])==1||trim($row_estrutura['lista_categoria'])==1||trim($row_estrutura['lista_sysplano'])==1||trim($row_estrutura['lista_sysservico'])==1) { ?>
                                                                    <li><a data-toggle="tab" href="#tb3_d">Relacionar itens</a></li>
                                                                    <? } ?>
                                                                    <? if(trim($row_estrutura['video'])==1) { ?>
                                                                    <li><a data-toggle="tab" href="#tb3_e">Vídeos</a></li>
                                                                    <? } ?>
                                                                    <? if(trim($row_estrutura['galeria'])==1) { ?>
                                                                    <li><a data-toggle="tab" href="#tb3_f">Arquivos</a></li>
                                                                    <? } ?>
                                                                    <? if(trim($row_estrutura['seo_item'])==1) { ?>
                                                                    <li><a data-toggle="tab" href="#tb3_g">Editar configurações SEO</a></li>
                                                                    <? } ?>
                                                                </ul>
                                                                <div class="tab-content">
                                                                    ...
                                                                    <div id="tb3_a" class="tab-pane active" style="min-height:350px;">
                                                                        ...
                                                                        <div class="formSep">
                                                                            <label class="req"><? if(trim($row_estrutura['cod_label'])=="") { echo "Código do sistema"; } else { echo $row_estrutura['cod_label']; } ?></label>
                                                                            <div class="input-append">
                                                                                <input value="<?=$row['cod']?>" class="span3" type="text" name="cod" id="cod" />
                                                                                <button type="button" onclick="gera_codigo_syssistemas();" class="btn">Gerar <? if(trim($row_estrutura['cod_label'])=="") { echo "Código do sistema"; } else { echo $row_estrutura['cod_label']; } ?></button>
                                                                            </div>
                                                                    ...
                                                                    <div id="tb3_b" class="tab-pane" style="min-height:350px;">
                                                                        ...
                                                                        <div class="formSep">
                                                                            <div style="float:left;margin-right:10px;">
                                                                                ...
                                                                                <select id="item_tipo_item" onchange="mostra_itens_syssistemas('');">
                                                                                    <option value="">---</option>
                                                                                    <option value="sysmodulos">Módulos</option>
                                                                                    <option value="sysproduto">Produtos, Soluções e Serviços</option>
                                                                                </select>
                                                                            </div>

                                                                            <div id="preloader" style="float:left;display:none;margin-top:30px;">
                                                                        ...
                                                                        <div class="formSep" id="campos_itens" style="display:none;">
                                                                            <div style="float:left;margin-right:10px;width:100%;">
                                                                                <div style="float:left;margin-right:10px;width:200px;">
                                                                                    <label>Categoria</label>
                                                                                    <select id="item_iditem_categoria" class="span12" onchange="mostra_itens_tipo('');">
                                                                                        <option value="">---</option>
                                                                                    </select>
                                                                                </div>
                                                                                <div style="float:left;margin-right:10px;width:200px;">
                                                                                    <label id="label-item"></label>
                                                                                    <select id="item_iditem" class="span12" onchange="preenche_valor_syssistemas('');">
                                                                                        <option value="">---</option>
                                                                                    </select>
                                                                                </div>
                                                                                <div id="cmp-idsysplano" style="float:left;margin-right:10px;width:220px;">
                                                                                    <label>Plano</label>
                                                                                    <select id="item_idsysplano" class="span12" disabled="disabled" onchange="preenche_valor_sysplano_syssistemas('');">
                                                                                        <option value="">---</option>
                                                                                    </select>
                                                                                </div>
                                                                                <div style="float:left;margin-right:10px;width:150px;">
                                                                                    <label>Valor</label>
                                                                                    <div class="input-prepend">
                                                                                    <span class="add-on">R$</span> <input value="" class="span9" type="text" id="item_valor" />
                                                                                    </div>
                                                                                </div>
                                                                                <div style="float:left;margin-right:10px;width:150px;">
                                                                                    <label>Mensalidade</label>
                                                                                    <div class="input-prepend">
                                                                                    <span class="add-on">R$</span> <input value="" class="span9" type="text" id="item_valor_mensalidade" />
                                                                                    </div>
                                                                                </div>
                                                                                <div style="float:left;margin-right:10px;width:50px;">
                                                                                    <button type="button" onclick="salvar_itens_syssistemas('');" style="margin-top:23px;" class="btn btn-primary">Adicionar</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
            
                                                                        <div class="formSep">
                                                                            <div id="lista-itens" style="width:100%;float:left;">
                                                                                <? $sufixoGet = ""; $numeroUnicoGet = $numeroUnicoGerado; include("./acoes/".$mod."/lista-itens.php"); ?>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div id="tb3_c" class="tab-pane" style="min-height:350px;">
                                                                        ...
                                                                        <? if(trim($row_estrutura['info_sistema'])==1) { ?>
                                                                        <div class="formSep">
                                                                            <label><? if(trim($row_estrutura['info_sistema_label'])=="") { echo "Informações do Produto"; } else { echo $row_estrutura['info_sistema_label']; } ?></label>
                                                                            <textarea name="info_sistema" id="info_sistema" class="span12" style="height:150px;"><?=$row['info_sistema']?></textarea>
                                                                            <? if(trim($row_estrutura['info_sistema_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;margin-top:10px;"><?=$row_estrutura['info_sistema_info']?></span><? } ?>
                                                                        </div>
                                                                        <? } ?>
                                                                        ...
                                                                        <div class="formSep">
                                                                            ...
                                                                            <div style="margin-right:10px;width:100%;float:left;">
                                                                                ...
                                                                                <div style="float:left;margin-right:10px;margin-top:24px;">
                                                                                    <button type="button" onclick="javascript:adicionar_video_syssistemas('<?=$mod?>','');" class="btn btn-primary">Adicionar Vídeo</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="formSep" id="galeria-video" style="margin-right:10px;width:100%;margin-bottom:50px;float:left;margin-top:20px;">
                                                                            <? $numeroUnicoGet = $numeroUnicoGerado; include("./acoes/".$mod."/lista_video.php"); ?>
                                                                        </div>
                                                            ...
                                                            <div class="formSep">
                                                                ...
                                                                <button type="button" onclick="clonar_item();" class="btn btn-beoro-6">Clonar este sistema</button>
                                                        ...
                                                        <div class="w-box-content">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <? if(trim($row_estrutura['valor'])==1) { ?>
                                                                    <th style="width:135px;"><? if(trim($row_estrutura['valor_label'])=="") { echo "Valor"; } else { echo $row_estrutura['valor_label']; } ?></th>
                                                                    <? } ?>
                                                                    <? if(trim($row_estrutura['valor_promocao'])==1) { ?>
                                                                    <th style="width:125px;"><? if(trim($row_estrutura['valor_promocao_label'])=="") { echo "Valor de promoção"; } else { echo $row_estrutura['valor_promocao_label']; } ?></th>
                                                                    <? } ?>
                                                                    <? if(trim($row_estrutura['valor_mensalidade'])==1) { ?>
                                                            ...
                                                            <div class="tabbable tabs-left tabbable-bordered">
                                                                ...
                                                                <div class="tab-content">
                                                                    ...
                                                                    <div id="tb3_c" class="tab-pane" style="min-height:350px;">
                                                                        ...
                                                                        <div class="formSep">
                                                                            <label><? if(trim($row_estrutura['info_sistema_label'])=="") { echo "Informações do Produto"; } else { echo $row_estrutura['info_sistema_label']; } ?></label>
                                                                            <textarea name="info_sistema" id="info_sistema" class="span12" style="height:150px;"></textarea>
                                                                            <? if(trim($row_estrutura['info_sistema_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;margin-top:10px;"><?=$row_estrutura['info_sistema_info']?></span><? } ?>
                                                                        </div>
                                                                        <? } ?>
                                                        ...
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>/" target="_self" ENCTYPE="multipart/form-data">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                                    ...
                                                                    <input type="checkbox" name="syssistemas_set" id="syssistemas_set" <? if(trim($row_config['syssistemas_set'])==1) { echo " checked"; } ?> class="syssistemas_set {labelOn: 'SIM', labelOff: 'NÃO'}" />
                                                                </div>
                                                            </div>
                                                ...
                                                <div id="tb1_estrutura" class="tab-pane">
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>/" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label class="req">Campo 'Código do sistema'</label>
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    ...
                                                                    <input value="<?=$row_estrutura['info_sistema_label']?>"  style="width:350px;" type="text" name="info_sistema_label" id="info_sistema_label" />
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                                    <label>Ativo ?</label>
                                                                    <input type="checkbox" name="info_sistema" id="info_sistema_estrutura" <? if(trim($row_estrutura['info_sistema'])==1) { echo " checked"; } ?> class="info_sistema_estrutura {labelOn: 'SIM', labelOff: 'NÃO'}" />
                                                                </div>
                                                                <div style="float:left;margin-right:10px;width:100%;">
                                                                    <label>Informações Extras</label>
                                                                    <input value="<?=$row_estrutura['info_sistema_info']?>"class="span7" type="text" name="info_sistema_info" id="info_sistema_info" />
                                                                </div>
                                                            </div>
