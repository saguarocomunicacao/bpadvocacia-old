		...
		if(trim($_POST['acaoForm'])=="editar") {
			...
			if(trim($_POST['acaoForm'])=="config") {
				...
				if($nConfig==0) { 
					...
					if(trim($_POST['syssistemas_set'])=="") { $_POST['syssistemas_set']=0; } else { $_POST['syssistemas_set']=1; }
					...
					$update = mysql_query("UPDATE ".$mod."_config SET 
																	 ...
																	 syssistemas_set='".$_POST['syssistemas_set']."', 
					...
					if(trim($_POST['acaoForm'])=="publicar") {
						...
						if(trim($_POST['acaoForm'])=="despublicar") {
							...
							if(trim($_POST['acaoForm'])=="config_seo") {
								...
								if(trim($_POST['idsyssistemas_categoria'])=="") { $_POST['idsyssistemas_categoria']=0; } else { $_POST['idsyssistemas_categoria']=1; }
								if(trim($_POST['lista_relacionado'])=="") { $_POST['lista_relacionado']=0; } else { $_POST['lista_relacionado']=1; }
								if(trim($_POST['lista_categoria'])=="") { $_POST['lista_categoria']=0; } else { $_POST['lista_categoria']=1; }
								if(trim($_POST['lista_sysplano'])=="") { $_POST['lista_sysplano']=0; } else { $_POST['lista_sysplano']=1; }
								if(trim($_POST['lista_sysservico'])=="") { $_POST['lista_sysservico']=0; } else { $_POST['lista_sysservico']=1; }
								...
								if(trim($_POST['qtd_estoque'])=="") { $_POST['qtd_estoque']=0; } else { $_POST['qtd_estoque']=1; }
								if(trim($_POST['frete'])=="") { $_POST['frete']=0; } else { $_POST['frete']=1; }
								...
								if(trim($_POST['info_sistema'])=="") { $_POST['info_sistema']=0; } else { $_POST['info_sistema']=1; }
								...
								if($nEstrutura==0) { 
									$insert = mysql_query("INSERT INTO ".$mod."_estrutura (
																						  ...
																						  seo_label,
																						  seo_item_label,
																						  idsyssistemas_categoria_label,
																						  lista_relacionado_label,
																						  lista_categoria_label,
																						  lista_sysplano_label,
																						  lista_sysservico_label,
																						  ordem_label,
																						  nome_label,
																						  cod_label,
																						  tags_label,
																						  ...
																						  idsyssistemas_categoria_info,
																						  lista_relacionado_info,
																						  lista_categoria_info,
																						  lista_sysplano_info,
																						  lista_sysservico_info,
																						  ordem_info,
																						  nome_info,
																						  cod_info,
																						  tags_info,
																						  ...
																						  '".$_POST['idsyssistemas_categoria']."',
																						  '".$_POST['lista_relacionado']."',
																						  '".$_POST['lista_categoria']."',
																						  '".$_POST['lista_sysplano']."',
																						  '".$_POST['lista_sysservico']."',
																						  '".$_POST['ordem']."',
																						  '".$_POST['nome']."',
																						  '".$_POST['cod']."',
																						  '".$_POST['tags']."',
																						  ...
																						  '".$_POST['idsyssistemas_categoria_label']."',
																						  '".$_POST['lista_relacionado_label']."',
																						  '".$_POST['lista_categoria_label']."',
																						  '".$_POST['lista_sysplano_label']."',
																						  '".$_POST['lista_sysservico_label']."',
																						  '".$_POST['ordem_label']."',
																						  '".$_POST['nome_label']."',
																						  '".$_POST['cod_label']."',
																						  '".$_POST['tags_label']."',
																						  ...
																						  '".$_POST['qtd_estoque_label']."',
																						  '".$_POST['frete_label']."',
																						  '".$_POST['imagem_label']."',
																						  '".$_POST['destaque_label']."',
																						  '".$_POST['lancamento_label']."',
																						  '".$_POST['chamada_label']."',
																						  '".$_POST['texto_label']."',
																						  '".$_POST['info_sistema_label']."',
																						  ...
																						  '".$_POST['idsyssistemas_categoria_info']."',
																						  '".$_POST['lista_relacionado_info']."',
																						  '".$_POST['lista_categoria_info']."',
																						  '".$_POST['lista_sysplano_info']."',
																						  '".$_POST['lista_sysservico_info']."',
																						  '".$_POST['ordem_info']."',
																						  '".$_POST['nome_info']."',
																						  '".$_POST['cod_info']."',
																						  '".$_POST['tags_info']."',
																						  ...
																						  '".$_POST['qtd_estoque_info']."',
																						  '".$_POST['frete_info']."',
																						  '".$_POST['imagem_info']."',
																						  '".$_POST['destaque_info']."',
																						  '".$_POST['lancamento_info']."',
																						  '".$_POST['chamada_info']."',
																						  '".$_POST['texto_info']."',
																						  '".$_POST['info_sistema_info']."',
									...
									$update = mysql_query("UPDATE ".$mod."_estrutura SET 
																						 ...
																						 idsyssistemas_categoria='".$_POST['idsyssistemas_categoria']."',
																						 lista_relacionado='".$_POST['lista_relacionado']."',
																						 lista_categoria='".$_POST['lista_categoria']."',
																						 lista_sysplano='".$_POST['lista_sysplano']."',
																						 lista_sysservico='".$_POST['lista_sysservico']."',
																						 ordem='".$_POST['ordem']."',
																						 nome='".$_POST['nome']."',
																						 cod='".$_POST['cod']."',
																						 tags='".$_POST['tags']."',
																						 ...
																						 texto='".$_POST['texto']."',
																						 info_sistema='".$_POST['info_sistema']."',
																						 ...
																						 idsyssistemas_categoria_label='".$_POST['idsyssistemas_categoria_label']."',
																						 lista_relacionado_label='".$_POST['lista_relacionado_label']."',
																						 lista_categoria_label='".$_POST['lista_categoria_label']."',
																						 lista_sysplano_label='".$_POST['lista_sysplano_label']."',
																						 lista_sysservico_label='".$_POST['lista_sysservico_label']."',
																						 ...
																						 qtd_estoque_label='".$_POST['qtd_estoque_label']."',
																						 frete_label='".$_POST['frete_label']."',
																						 imagem_label='".$_POST['imagem_label']."',
																						 destaque_label='".$_POST['destaque_label']."',
																						 lancamento_label='".$_POST['lancamento_label']."',
																						 chamada_label='".$_POST['chamada_label']."',
																						 texto_label='".$_POST['texto_label']."',
																						 info_sistema_label='".$_POST['info_sistema_label']."',
																						 ...
																						 idsyssistemas_categoria_info='".$_POST['idsyssistemas_categoria_info']."',
																						 lista_relacionado_info='".$_POST['lista_relacionado_info']."',
																						 lista_categoria_info='".$_POST['lista_categoria_info']."',
																						 lista_sysplano_info='".$_POST['lista_sysplano_info']."',
																						 lista_sysservico_info='".$_POST['lista_sysservico_info']."',
																						 ...
																						 qtd_estoque_info='".$_POST['qtd_estoque_info']."',
																						 frete_info='".$_POST['frete_info']."',
																						 imagem_info='".$_POST['imagem_info']."',
																						 destaque_info='".$_POST['destaque_info']."',
																						 lancamento_info='".$_POST['lancamento_info']."',
																						 chamada_info='".$_POST['chamada_info']."',
																						 texto_info='".$_POST['texto_info']."',
																						 info_sistema_info='".$_POST['info_sistema_info']."',
