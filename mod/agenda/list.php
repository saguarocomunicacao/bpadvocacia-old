                                                    ...
                                                    if($('#dt_basic').length) {
                                                        $('#dt_basic').dataTable({
															...
															"aoColumns": [
																...
																<? if(trim($row_estrutura['lista_categorias'])==1) { ?>{ "bSortable": false },<? } ?>
																{ "sType": "string" },
																{ "bSortable": false }
															]
                                                        });
                                                        ...
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    ...
                                                                    <input class="span8" value="<? if(trim($row['data_despublicacao'])==""||trim($row['data_despublicacao'])=="0000-00-00") { echo ""; } else { ajustaDataSemHora($row['data_despublicacao'],"d/m/Y"); } ?>" data-date-format="dd/mm/yyyy" name="data_despublicacao" id="data_despublicacao" type="text">
                                                    ...
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label><? if(trim($row_estrutura['data_despublicacao_label'])=="") { echo "Data de Despublicação"; } else { echo $row_estrutura['data_despublicacao_label']; } ?></label>
                                                                    <input class="span8" value="" data-date-format="dd/mm/yyyy" name="data_despublicacao" id="data_despublicacao" type="text">
                                                                    <? if(trim($row_estrutura['data_despublicacao_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;"><?=$row_estrutura['data_despublicacao_info']?></span><? } ?>
                                                                </div>
                                                            </div>
                                                            <? } ?>
