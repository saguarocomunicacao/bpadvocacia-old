					...
					if(trim($_POST['acaoForm'])=="publicar") {
						...
						if(trim($_POST['acaoForm'])=="despublicar") {
							...
							if(trim($_POST['acaoForm'])=="config_seo") {
								...
								if(trim($_POST['idarea_atuacao_categoria'])=="") { $_POST['idarea_atuacao_categoria']=0; } else { $_POST['idarea_atuacao_categoria']=1; }
								...
								if($nEstrutura==0) { 
									$insert = mysql_query("INSERT INTO ".$mod."_estrutura (
																						  ...
																						  seo_label,
																						  seo_item_label,
																						  idarea_atuacao_categoria_label,
																						  ordem_label,
																						  nome_label,
																						  destaque_label,
																						  imagem_label,
																						  ...
																						  '".$_POST['idarea_atuacao_categoria']."',
																						  '".$_POST['ordem']."',
																						  '".$_POST['nome']."',
																						  '".$_POST['destaque']."',
																						  '".$_POST['imagem']."',
																						  ...
																						  '".$_POST['idarea_atuacao_categoria_label']."',
																						  '".$_POST['ordem_label']."',
																						  '".$_POST['nome_label']."',
																						  ...
																						  '".$_POST['idarea_atuacao_categoria_info']."',
																						  '".$_POST['ordem_info']."',
																						  '".$_POST['nome_info']."',
																						  '".$_POST['destaque_info']."',
																						  '".$_POST['imagem_info']."',
									...
									$update = mysql_query("UPDATE ".$mod."_estrutura SET 
																						 ...
																						 idarea_atuacao_categoria='".$_POST['idarea_atuacao_categoria']."',
																						 ordem='".$_POST['ordem']."',
																						 nome='".$_POST['nome']."',
																						 ...
																						 idarea_atuacao_categoria_label='".$_POST['idarea_atuacao_categoria_label']."',
																						 ...
																						 idarea_atuacao_categoria_info='".$_POST['idarea_atuacao_categoria_info']."',
