					...
					if(trim($_POST['acaoForm'])=="publicar") {
						...
						if(trim($_POST['acaoForm'])=="despublicar") {
							...
							if(trim($_POST['acaoForm'])=="config_seo") {
								...
								if(trim($_POST['idsystemplate_categoria'])=="") { $_POST['idsystemplate_categoria']=0; } else { $_POST['idsystemplate_categoria']=1; }
								...
								if($nEstrutura==0) { 
									$insert = mysql_query("INSERT INTO ".$mod."_estrutura (
																						  ...
																						  '".$_POST['idsystemplate_categoria_label']."',
																						  '".$_POST['ordem_label']."',
																						  '".$_POST['nome_label']."',
																						  '".$_POST['imagem_label']."',
																						  '".$_POST['link_label']."',
																						  ...
																						  '".$_POST['idsystemplate_categoria_info']."',
																						  '".$_POST['ordem_info']."',
																						  '".$_POST['nome_info']."',
																						  '".$_POST['imagem_info']."',
																						  '".$_POST['link_info']."',
									...
									$update = mysql_query("UPDATE ".$mod."_estrutura SET 
																						 ...
																						 idsystemplate_categoria='".$_POST['idsystemplate_categoria']."',
																						 ordem='".$_POST['ordem']."',
																						 nome='".$_POST['nome']."',
																						 imagem='".$_POST['imagem']."',
																						 link='".$_POST['link']."',
																						 ...
																						 idsystemplate_categoria_label='".$_POST['idsystemplate_categoria_label']."',
																						 ...
																						 idsystemplate_categoria_info='".$_POST['idsystemplate_categoria_info']."',
