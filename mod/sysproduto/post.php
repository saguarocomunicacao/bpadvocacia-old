					...
					if(trim($_POST['acaoForm'])=="publicar") {
						...
						if(trim($_POST['acaoForm'])=="despublicar") {
							...
							if(trim($_POST['acaoForm'])=="config_seo") {
								...
								if(trim($_POST['idsysproduto_categoria'])=="") { $_POST['idsysproduto_categoria']=0; } else { $_POST['idsysproduto_categoria']=1; }
								...
								if($nEstrutura==0) { 
									$insert = mysql_query("INSERT INTO ".$mod."_estrutura (
																						  ...
																						  '".$_POST['idsysproduto_categoria_label']."',
																						  ...
																						  '".$_POST['idsysproduto_categoria_info']."',
									...
									$update = mysql_query("UPDATE ".$mod."_estrutura SET 
																						 ...
																						 idsysproduto_categoria='".$_POST['idsysproduto_categoria']."',
																						 ...
																						 idsysproduto_categoria_label='".$_POST['idsysproduto_categoria_label']."',
																						 ...
																						 idsysproduto_categoria_info='".$_POST['idsysproduto_categoria_info']."',
