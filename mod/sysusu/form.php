        <!-- main content -->
                                ...
                                <div class="row-fluid">
                                    <div class="span12">
                                        <div class="tabbable tabbable-bordered">
											...
											<? $sysusu_set_mapa = mysql_fetch_array(mysql_query("SELECT * FROM sysusu_geolocalization WHERE idsysusu='".$sysusu['id']."'")); ?>
											/*
											var eu = new google.maps.LatLng(<?= $sysusu_set_mapa['lat'] ?>, <?= $sysusu_set_mapa['lng'] ?>);
											
											var markers_editar = [];
											var map_editar;
											function initialize_editar() {
											  var mapOptions_editar = {
												zoom: 12,
												center: eu
											  };
											
											  map_editar = new google.maps.Map(document.getElementById('gmap_markers_editar'),mapOptions_editar);
											}
											google.maps.event.addDomListener(window, 'load', initialize_editar);
                                            ...
                                            <div class="tab-content">
                                                        ...
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>/" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label>Definir este usuário como administrador ?</label>
                                                                    <select name="adm" id="adm">
                                                                        <option value="">---</option>
                                                                        <option value="0" <? if($row['adm']=="0") { echo "selected"; } ?>>NÃO</option>
                                                                        <option value="1" <? if($row['adm']=="1") { echo "selected"; } ?>>SIM</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <? } ?>
                                                            ...
                                                            <div class="formSep">
                                                                <button type="button" onclick="getLocationComEndereco('_editar')" class="btn btn-primary">Carregar mapa</button><br /><br />
                                                                <div id="gmap_markers_editar" class="gmap" style="height:600px;display:block;"></div>
                                                            </div>
                                                            -->
                                                            ...
                                                            <div class="formSep">
                                                                ...
                                                                <? } ?>
                                                                <button type="button" onclick="getLocationComEndereco('<?=$_REQUEST['var4']?>')" class="btn btn-success">Salvar</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="tb1_c" class="tab-pane">
                                                    ...
                                                    <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>/" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                        ...
                                                        <div class="formSep">
                                                            <label class="req">Imagem de Perfil</label>
                                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                        ...
                                                        <!--
                                                        <div class="formSep">
                                                            <button type="button" onclick="getLocationComEndereco('')" class="btn btn-primary">Carregar mapa</button><br /><br />
                                                            <div id="gmap_markers" class="gmap" style="height:600px;display:block;"></div>
                                                        </div>
                                                        -->
                                                        ...
                                                        <div class="formSep">
                                                            ...
                                                            <label class="radio" style="color:#390;">
                                                                <input type="radio" name="stat" id="ativo2" value="1" >
                                                                sim
                                                            </label>
                                                        </div>	
            ...
            <!--<script>getLocationComEndereco('_editar')</script>-->
