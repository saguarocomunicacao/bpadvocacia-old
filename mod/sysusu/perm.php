                        ...
                        <div class="span12">
                            <div class="tabbable tabbable-bordered">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#tb1_a">Permissões de  <?=$row['nome']?></a></li>
								...
								beoro_switchButtons = {
									init: function() {
										...
										if($('#visualizar_sysagenda').length) { $("#visualizar_sysagenda").iButton(); }
                                    ...
                                    <div id="tb1_a" class="tab-pane active">
                                        <div>
                                            <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>/" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                ...
                                                <input type="hidden" name="modulo" value="syspermadmin" />
                                                <input type="hidden" name="idsysusu" value="<?=$_REQUEST['var4']?>" />
    
                                                <?
                                                if(trim($row['numeroUnico'])=="") { 
                                                ...
                                                <div class="tabbable tabs-left tabbable-bordered">
                                                    <ul class="nav nav-tabs">
                                                        <li class="active"><a data-toggle="tab" href="#tb3_a">Sistema</a></li>
                                                        <?
                                                    ...
                                                    <div class="tab-content">
                                                        <div id="tb3_a" class="tab-pane active" style="min-height:350px;">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;width:100%;">
                                                                    <label><b>Módulo de Agenda</b></label>
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                                    <label style="font-size:10px;">Visualizar</label>
                                                                    <input type="checkbox" name="visualizar_sysagenda" id="visualizar_sysagenda" <? if(trim($rSyspermadmin['visualizar_sysagenda'])==1) { echo " checked"; } ?> class="visualizar_sysagenda {labelOn: 'SIM', labelOff: 'NÃO'}" />
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div id="tb3_<?=$rSqlCat['id']?>" class="tab-pane" style="min-height:350px;">
                                                            ...
                                                            <div class="formSep">
                                                                ...
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;width:200px;">
                                                                    ...
                                                                    &&trim($rSyspermadmin['todos_'.$rSql['bd'].''])==1
                                                                ...
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                                    ...
                                                                    <input type="checkbox" name="todos_<?=$rSql['bd']?>" id="todos_<?=$rSql['bd']?>" <? if(trim($rSyspermadmin['todos_'.$rSql['bd'].''])==1) { echo " checked"; } ?> class="item_<?=$rSql['bd']?> todos_<?=$rSql['bd']?> {labelOn: 'SIM', labelOff: 'NÃO'}" />
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                                    <label style="font-size:10px;">Inserir</label>
                                                ...
                                                <div class="formSep">
                                                    <? if(trim($sysperm['editar_syspermadmin'])==1) { ?>
