                                                ...
                                                <div id="tb1_editar" class="tab-pane active">
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <label><? if(trim($row_estrutura['imagem_label'])=="") { echo "Arquivo"; } else { echo $row_estrutura['imagem_label']; } ?></label>
                                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                    <div class="fileupload-new thumbnail">
                                                                    <? if(trim($row['imagem'])=="") { ?>
                                                                    <img src="<?=$link?>template/img/dummy_50x50.gif" alt="" >
                                                                    <? } else { ?>
                                                                    <a class="img_action_zoom" href="<?=$link?>include/lib/forca-download.php?arquivo=../../files/<?=$linguagem_set?><?=$mod?>/<?=$rSql['numeroUnico']?>/<?=$rSql['imagem']?>"><?=$rSql['imagem']?></a>
                                                                    <? } ?>
                                                                    </div>
                                                                    ...
                                                                    <a href="javascript:void(0);" onclick="remover_imagem('<?=$row['id']?>','<?=$mod?>_item','imagem');" class="btn btn-small" data-dismiss="fileupload">Remover</a>
                                                                    <? } ?>
                                                                </div>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr id="linha-<?=$rSql['id']?>">
                                                                    ...
                                                                    <td style="vertical-align:middle;" class="nolink">
                                                                        ...
                                                                        <? if(trim($row_estrutura['imagem'])==1) { ?>
																		<? if(trim($rSql['imagem'])=="") { ?>
                                                                        <a href="javascript:void(0);" class="btn-mini ptip_se"  onclick="alert('Sem arquivo anexado!');"><img src="<?=$link?>template/img/icones_novos/16/download.png" /></a>
																		<? } else { ?>
                                                                        <a class="btn-mini ptip_se" href="<?=$link?>include/lib/forca-download.php?arquivo=../../files/<?=$linguagem_set?><?=$mod?>/<?=$rSql['numeroUnico']?>/<?=$rSql['imagem']?>"><img src="<?=$link?>template/img/icones_novos/16/download.png" /></a>
																		<? } ?>
                                                                        <? } ?>
                                                ...
                                                <div id="tb1_estrutura" class="tab-pane">
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label class="req">Campo 'Arquivo'</label>
