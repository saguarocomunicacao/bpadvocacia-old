					...
					if(trim($_POST['acaoForm'])=="publicar") {
						...
						if(trim($_POST['acaoForm'])=="despublicar") {
							...
							if(trim($_POST['acaoForm'])=="config_seo") {
								...
								if(trim($_POST['iddownload_categoria'])=="") { $_POST['iddownload_categoria']=0; } else { $_POST['iddownload_categoria']=1; }
								...
								if($nEstrutura==0) { 
									$insert = mysql_query("INSERT INTO ".$mod."_estrutura (
																						  ...
																						  '".$_POST['iddownload_categoria_label']."',
																						  '".$_POST['ordem_label']."',
																						  '".$_POST['nome_label']."',
																						  '".$_POST['imagem_label']."',
																						  '".$_POST['texto_label']."',
																						  ...
																						  '".$_POST['iddownload_categoria_info']."',
																						  '".$_POST['ordem_info']."',
																						  '".$_POST['nome_info']."',
																						  '".$_POST['imagem_info']."',
																						  '".$_POST['texto_info']."'
									...
									$update = mysql_query("UPDATE ".$mod."_estrutura SET 
																						 ...
																						 iddownload_categoria='".$_POST['iddownload_categoria']."',
																						 ordem='".$_POST['ordem']."',
																						 nome='".$_POST['nome']."',
																						 imagem='".$_POST['imagem']."',
																						 texto='".$_POST['texto']."',
																						 ...
																						 iddownload_categoria_label='".$_POST['iddownload_categoria_label']."',
																						 ordem_label='".$_POST['ordem_label']."',
																						 nome_label='".$_POST['nome_label']."',
																						 imagem_label='".$_POST['imagem_label']."',
																						 texto_label='".$_POST['texto_label']."',

																						 iddownload_categoria_info='".$_POST['iddownload_categoria_info']."',
