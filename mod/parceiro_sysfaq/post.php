					...
					if(trim($_POST['acaoForm'])=="publicar") {
						...
						if(trim($_POST['acaoForm'])=="despublicar") {
							...
							if(trim($_POST['acaoForm'])=="config_seo") {
								...
								if(trim($_POST['idparceiro_sysfaq_categoria'])=="") { $_POST['idparceiro_sysfaq_categoria']=0; } else { $_POST['idparceiro_sysfaq_categoria']=1; }
								if(trim($_POST['lista_sysgrupousuario'])=="") { $_POST['lista_sysgrupousuario']=0; } else { $_POST['lista_sysgrupousuario']=1; }
								...
								if($nEstrutura==0) { 
									$insert = mysql_query("INSERT INTO ".$mod."_estrutura (
																						  ...
																						  idparceiro_sysfaq_categoria,
																						  lista_sysgrupousuario,
																						  ordem,
																						  nome,
																						  imagem,
																						  texto,
																						  ...
																						  seo_label,
																						  seo_item_label,
																						  idparceiro_sysfaq_categoria_label,
																						  lista_sysgrupousuario_label,
																						  ordem_label,
																						  nome_label,
																						  imagem_label,
																						  texto_label,
																						  ...
																						  idparceiro_sysfaq_categoria_info,
																						  lista_sysgrupousuario_info,
																						  ordem_info,
																						  nome_info,
																						  imagem_info,
																						  texto_info,
																						  ...
																						  '".$_POST['idparceiro_sysfaq_categoria']."',
																						  '".$_POST['lista_sysgrupousuario']."',
																						  '".$_POST['ordem']."',
																						  '".$_POST['nome']."',
																						  '".$_POST['imagem']."',
																						  '".$_POST['texto']."',
																						  ...
																						  '".$_POST['idparceiro_sysfaq_categoria_label']."',
																						  '".$_POST['lista_sysgrupousuario_label']."',
																						  '".$_POST['ordem_label']."',
																						  '".$_POST['nome_label']."',
																						  '".$_POST['imagem_label']."',
																						  '".$_POST['texto_label']."',
																						  ...
																						  '".$_POST['idparceiro_sysfaq_categoria_info']."',
																						  '".$_POST['lista_sysgrupousuario_info']."',
																						  '".$_POST['ordem_info']."',
																						  '".$_POST['nome_info']."',
																						  '".$_POST['imagem_info']."',
																						  '".$_POST['texto_info']."',
									...
									$update = mysql_query("UPDATE ".$mod."_estrutura SET 
																						 ...
																						 idparceiro_sysfaq_categoria='".$_POST['idparceiro_sysfaq_categoria']."',
																						 lista_sysgrupousuario='".$_POST['lista_sysgrupousuario']."',
																						 ordem='".$_POST['ordem']."',
																						 nome='".$_POST['nome']."',
																						 imagem='".$_POST['imagem']."',
																						 texto='".$_POST['texto']."',
																						 ...
																						 idparceiro_sysfaq_categoria_label='".$_POST['idparceiro_sysfaq_categoria_label']."',
																						 lista_sysgrupousuario_label='".$_POST['lista_sysgrupousuario_label']."',
																						 ...
																						 idparceiro_sysfaq_categoria_info='".$_POST['idparceiro_sysfaq_categoria_info']."',
																						 lista_sysgrupousuario_info='".$_POST['lista_sysgrupousuario_info']."',
