                                    ...
                                    <div class="span12">
                                        <div class="tabbable tabbable-bordered">
											...
											beoro_enchancedSelect = {
												init: function() {
													if($('#idsysfornecedor').length) {
														$("#idsysfornecedor").select2({
                                                                    ...
                                                                    <div id="tb3_a" class="tab-pane active" style="min-height:350px;">
                                                                        ...
                                                                        <div class="formSep">
                                                                            <div style="float:left;margin-right:10px;width:300px;">
                                                                                <label id="label-perfil">Fornecedor</label>
                                                                                <select name="idsysfornecedor" id="idsysfornecedor" class="span12">
                                                                                    <option value=""></option>
                                                                                    <?
                                                                                    $qSqlCat = mysql_query("SELECT * FROM sysfornecedor_categoria WHERE stat='1' ORDER BY nome");
                                                                                    while($rSqlCat = mysql_fetch_array($qSqlCat)) {
                                                                                    ?>
                                                                                    <optgroup label="<?= $rSqlCat['nome'] ?>">
                                                                                        <?
                                                                                        $qSqlItem = mysql_query("SELECT * FROM sysfornecedor WHERE stat='1' AND idsysfornecedor_categoria='".$rSqlCat['id']."' ORDER BY nome");
                                                                                        while($rSqlItem = mysql_fetch_array($qSqlItem)) {
                                                                                        ?>
                                                                            ...
                                                                            <div id="div-add-sysfornecedor" style="float:left;margin-top:30px;display:block;">
                                                        ...
                                                        <div class="w-box-content">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr id="linha-<?=$rSql['id']?>">
                                                                    ...
                                                                    <? $sysfornecedor_table = mysql_fetch_array(mysql_query("SELECT * FROM sysfornecedor WHERE id='".$rSql['idsysfornecedor']."'")); ?>
