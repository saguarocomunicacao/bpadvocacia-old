					...
					if(trim($_POST['acaoForm'])=="publicar") {
						...
						if(trim($_POST['acaoForm'])=="despublicar") {
							...
							if(trim($_POST['acaoForm'])=="config_seo") {
								...
								if(trim($_POST['idfoto_categoria'])=="") { $_POST['idfoto_categoria']=0; } else { $_POST['idfoto_categoria']=1; }
								...
								if($nEstrutura==0) { 
									...
									$update = mysql_query("UPDATE ".$mod."_estrutura SET 
																						 ...
																						 idfoto_categoria='".$_POST['idfoto_categoria']."',
																						 ...
																						 idfoto_categoria_label='".$_POST['idfoto_categoria_label']."',
																						 ...
																						 idfoto_categoria_info='".$_POST['idfoto_categoria_info']."',
