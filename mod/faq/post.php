					...
					if(trim($_POST['acaoForm'])=="publicar") {
						...
						if(trim($_POST['acaoForm'])=="despublicar") {
							...
							if(trim($_POST['acaoForm'])=="config_seo") {
								...
								if(trim($_POST['idfaq_categoria'])=="") { $_POST['idfaq_categoria']=0; } else { $_POST['idfaq_categoria']=1; }
								...
								if($nEstrutura==0) { 
									...
									$update = mysql_query("UPDATE ".$mod."_estrutura SET 
																						 ...
																						 idfaq_categoria='".$_POST['idfaq_categoria']."',
																						 ordem='".$_POST['ordem']."',
																						 nome='".$_POST['nome']."',
																						 imagem='".$_POST['imagem']."',
																						 texto='".$_POST['texto']."',
																						 ...
																						 idfaq_categoria_label='".$_POST['idfaq_categoria_label']."',
																						 ...
																						 idfaq_categoria_info='".$_POST['idfaq_categoria_info']."',
