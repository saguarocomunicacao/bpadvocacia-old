		...
		if(trim($_POST['acaoForm'])=="editar") {
			...
			if(trim($_POST['acaoForm'])=="config") {
				...
				if($nConfig==0) { 
					...
					$insert = mysql_query("INSERT INTO ".$mod."_config (numeroUnico,nome,imagem_descricao,imagem_interna,chamada_descricao,texto_descricao,titulo_texto) VALUES ('".$_POST['numeroUnico']."','".$_POST['nome']."','".$_POST['imagem_descricao']."','".$_POST['imagem_interna']."','".$_POST['chamada_descricao']."','".$_POST['texto_descricao']."','".$_POST['titulo_texto']."')");
				} else {
					...
					$update = mysql_query("UPDATE ".$mod."_config SET numeroUnico='".$_POST['numeroUnico']."',nome='".$_POST['nome']."',imagem_descricao='".$_POST['imagem_descricao']."',imagem_interna='".$_POST['imagem_interna']."',chamada_descricao='".$_POST['chamada_descricao']."',texto_descricao='".$_POST['texto_descricao']."',titulo_texto='".$_POST['titulo_texto']."' WHERE id='".$itemAtual['id']."'");
				}
			} else {
