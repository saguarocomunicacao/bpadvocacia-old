                                        ...
                                        <div class="tabbable tabbable-bordered">
											...
											beoro_switchButtons = {
												init: function() {
													...
													if($('#lista_categorias_estrutura').length) { $("#lista_categorias_estrutura").iButton(); }
													...
													if($('#autor_estrutura').length) { $("#autor_estrutura").iButton(); }
													...
													if($('#link_video_estrutura').length) { $("#link_video_estrutura").iButton(); }
                                                ...
                                                <div id="tb1_editar" class="tab-pane active">
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <? if(trim($row_estrutura['categoria'])==1) { ?>
															<? if(trim($row_estrutura['lista_categorias'])==1) { ?>
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;width:550px;">
                                                                    <label><? if(trim($row_estrutura['lista_categorias_label'])=="") { echo "Escolha a categoria"; } else { echo $row_estrutura['lista_categorias_label']; } ?></label>
                                                                ...
                                                                <? if(trim($row_estrutura['lista_categorias_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;"><?=$row_estrutura['lista_categorias_info']?></span><? } ?>
                                                            </div>
                                                            <? } ?>
                                                            <? } ?>
                                                            ...
                                                            <? if(trim($row_estrutura['autor'])==1) { ?>
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label><? if(trim($row_estrutura['autor_label'])=="") { echo "Autor"; } else { echo $row_estrutura['autor_label']; } ?></label>
                                                                    <input value="<?=$row['autor']?>" style="width:350px;" type="text" name="autor" id="autor" />
                                                                </div>
                                                                <? if(trim($row_estrutura['autor_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;"><?=$row_estrutura['autor_info']?></span><? } ?>
                                                            </div>
                                                            <? } ?>

                                                            <? if(trim($row_estrutura['link_video'])==1) { ?>
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label><? if(trim($row_estrutura['link_video_label'])=="") { echo "Link de Vídeo"; } else { echo $row_estrutura['link_video_label']; } ?></label>
                                                                    <input value="<?=$row['link_video']?>" style="width:350px;" type="text" name="link_video" id="link_video" />
                                                                </div>
                                                                <? if(trim($row_estrutura['link_video_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;"><?=$row_estrutura['link_video_info']?></span><? } ?>
                                                            </div>
                                                            <? } ?>
                                                ...
                                                <div id="tb1_lista" class="tab-pane <? if(trim($_REQUEST['var3'])=="") { ?>active<? } ?>">
                                                    <div class="w-box w-box">
                                                        ...
                                                        <div class="w-box-content">
                                                            ...
                                                            <tbody>
                                                                <?
                                                                $qSql = mysql_query("SELECT * FROM ".$linguagem_set."".$mod." ORDER BY data_post DESC, hora_post DESC");
                                                        ...
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;width:100%;">
                                                                    <label><? if(trim($row_estrutura['nome_label'])=="") { echo "Título"; } else { echo $row_estrutura['nome_label']; } ?></label>
                                                                    <input value="" class="span7" onkeyup="cria_titulo_e_url('nome','titulo_seo','titulo_seo_google','url_amigavel','url_amigavel_google','Título','titulo_seo_contador','55');" type="text" name="nome" id="nome" />
                                                                </div>
                                                                <? if(trim($row_estrutura['nome_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;"><?=$row_estrutura['nome_info']?></span><? } ?>
                                                            </div>
                                                            <? } ?>
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label><? if(trim($row_estrutura['autor_label'])=="") { echo "Autor"; } else { echo $row_estrutura['autor_label']; } ?></label>
                                                                    <input value="" style="width:350px;" type="text" name="autor" id="autor" />
                                                                </div>
                                                                <? if(trim($row_estrutura['autor_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;"><?=$row_estrutura['autor_info']?></span><? } ?>
                                                            </div>
                                                            <? } ?>
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label><? if(trim($row_estrutura['link_video_label'])=="") { echo "Link de Vídeo"; } else { echo $row_estrutura['link_video_label']; } ?></label>
                                                                    <input value="" style="width:350px;" type="text" name="link_video" id="link_video" />
                                                                </div>
                                                                <? if(trim($row_estrutura['link_video_info'])=="") { } else { ?><span class="help-block" style="width:100%;float:left;"><?=$row_estrutura['link_video_info']?></span><? } ?>
                                                            </div>
                                                            <? } ?>
                                                ...
                                                <div id="tb1_estrutura" class="tab-pane">
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var1']?>/<?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label class="req">Campo 'Lista de Categorias'</label>
                                                                    <input value="<?=$row_estrutura['lista_categorias_label']?>"  style="width:350px;" type="text" name="lista_categorias_label" id="lista_categorias_label" />
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                                    <label>Ativo ?</label>
                                                                    <input type="checkbox" name="lista_categorias" id="lista_categorias_estrutura" <? if(trim($row_estrutura['lista_categorias'])==1) { echo " checked"; } ?> class="lista_categorias_estrutura {labelOn: 'SIM', labelOff: 'NÃO'}" />
                                                                </div>
                                                                <div style="float:left;margin-right:10px;width:100%;">
                                                                    <label>Informações Extras</label>
                                                                    <input value="<?=$row_estrutura['lista_categorias_info']?>"class="span7" type="text" name="lista_categorias_info" id="lista_categorias_info" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    <label class="req">Campo 'Link de Vídeo'</label>
                                                                    <input value="<?=$row_estrutura['link_video_label']?>"  style="width:350px;" type="text" name="link_video_label" id="link_video_label" />
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                                    <label>Ativo ?</label>
                                                                    <input type="checkbox" name="link_video" id="link_video_estrutura" <? if(trim($row_estrutura['link_video'])==1) { echo " checked"; } ?> class="link_video_estrutura {labelOn: 'SIM', labelOff: 'NÃO'}" />
                                                                </div>
                                                                <div style="float:left;margin-right:10px;width:100%;">
                                                                    <label>Informações Extras</label>
                                                                    <input value="<?=$row_estrutura['link_video_info']?>"class="span7" type="text" name="link_video_info" id="link_video_info" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    ...
                                                                    <select name="campo_ordem_1" id="campo_ordem_1">
                                                                        ...
                                                                        <option value='autor' <? if($row_estrutura['campo_ordem_1']=="autor") { echo "selected"; } ?>><? if(trim($row_estrutura['autor_label'])=="") { echo "Autor"; } else { echo $row_estrutura['autor_label']; } ?></option>
                                                                    </select>
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
                                                            ...
                                                            <div class="formSep">
                                                                <div style="float:left;margin-right:10px;">
                                                                    ...
                                                                    <select name="campo_ordem_2" id="campo_ordem_2">
                                                                        ...
                                                                        <option value='autor' <? if($row_estrutura['campo_ordem_2']=="autor") { echo "selected"; } ?>><? if(trim($row_estrutura['autor_label'])=="") { echo "Autor"; } else { echo $row_estrutura['autor_label']; } ?></option>
                                                                    </select>
                                                                </div>
                                                                <div style="float:left;margin-right:10px;padding-bottom:10px;">
