                                                    ...
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <div class="formSep">
                                                                ...
                                                                <input value="<?=$row['valor']?>" class="span5" type="text" name="valor" id="valor" />
                                                            ...
                                                            <div class="formSep">
                                                                ...
                                                                <div style="margin-right:10px;width:100%;float:left;">
                                                                    ...
                                                                    <div style="float:left;margin-right:10px;margin-top:24px;">
                                                                        <button type="button" onclick="javascript:adicionar_video_produto('<?=$mod?>','_editar');" class="btn btn-primary">Adicionar Vídeo</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div>
                                                        <form name="forms" method="post" action="<?=$link?><?=$_REQUEST['var2']?>" target="_self" ENCTYPE="multipart/form-data" id="forms">
                                                            ...
                                                            <script type="text/javascript" >
                                                                $(function(){
                                                                    new AjaxUpload($('#upload-arquivo'), {
                                                                        action: '<?=$link?>acoes/produto/drop-arquivo.php?numeroUnicoS=<?=$numeroUnicoGerado?>',
																		name: 'file',
                                                                        onSubmit: function(file, ext){
                                                                        },
                                                                        onComplete: function(file, response){
