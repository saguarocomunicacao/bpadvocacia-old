...
$syscliente = mysql_fetch_array(mysql_query("SELECT * FROM syscliente WHERE id='".$syscontrato['idsyscliente']."'"));

$link_completo = "".$linkGet."cliente/aceite-digital/".$syscontrato['numeroUnico']."/";
...
$msg .= "<body>";
$msg .= "<table width=\"100%\">";
	$qSqlGroup = mysql_query("SELECT * FROM syscontrato_item WHERE numeroUnico_pai='".$numeroUnicoGet."' GROUP BY idsysproduto_categoria");
...
$msg .= "
		...
		$cor = "#f0f0f0";
		$qSqlItem = mysql_query("SELECT * FROM syscontrato_item WHERE numeroUnico_pai='".$numeroUnicoGet."' AND idsysproduto_categoria='".$rSqlGroup['idsysproduto_categoria']."' ORDER BY data DESC");
...
$msg .= "
		...
		<tr style=\"background-color:#81bb0d;\">
			<td colspan=\"5\" style=\"vertical-align:middle;padding-top:10px;padding-bottom:10px;text-align:center;font-weight:bold;font-size:20px;\"><a href=\"".$link_completo."\" style=\"color:#FFF;text-decoration:none;\" >Se você aceita e concorda com todos os termos do contrato acima, clique aqui para realizar o aceite digital</a></td>
		</tr>
	</table>";
$msg .= "
</body>
...
$assunto  = "Contrato ".$sysconfig['nome']."";
