                                                                                ...
                                                                                validate: function(value) {
                                                                                   if($.trim(value) == '') { 
                                                                                    return 'Este campo é obrigatório';
                                                                                       ...
                                                                                       edita_ordem_categoria('lista_categoria','<?=$rSqlCategoria['id']?>','<?=$modGet?>','_categoria',value);
                                                                                   }
                                                                                }
                                                                            });
                                                                                ...
                                                                                validate: function(value) {
                                                                                   if($.trim(value) == '') { 
                                                                                    return 'Este campo é obrigatório';
                                                                                       ...
                                                                                       salva_campo_tabela_ajax('lista_categoria','_categoria','nome','<?=$rSqlCategoria['id']?>','<?=$modGet?>',value);
                                                                                   }
                                                                                }
                                                                            });
                                                                                ...
                                                                                validate: function(value) {
                                                                                   if($.trim(value) == '') { 
                                                                                    return 'Este campo é obrigatório';
                                                                                       ...
                                                                                       salva_campo_tabela_ajax('lista_categoria','_categoria','url_amigavel','<?=$rSqlCategoria['id']?>','<?=$modGet?>',value);
                                                                                   }
                                                                                }
                                                                            });
                                                                        ...
                                                                        <tr id="lista_categoria_<?=$rSqlCategoria['id']?>">
                                                                            ...
                                                                            <td style="vertical-align:middle;" class="nolink">
																				...
																				<? if(trim($rSqlCategoria['stat'])=="1") { ?>
                                                                                    <? if(trim($sysperm['despublicar_'.$modGet.''.$subLocalGet.''])==1) { ?>
                                                                                    ...
                                                                                    <? } ?>
                                                                                <? } else { ?>
                                                                                    <? if(trim($sysperm['publicar_'.$modGet.''.$subLocalGet.''])==1) { ?>
