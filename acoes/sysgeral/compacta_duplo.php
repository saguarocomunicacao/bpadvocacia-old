...
$lista2IdGet = str_replace("||","','",$_GET['lista2IdS']);
...
while($rSqlItem = mysql_fetch_array($qSqlItem)) {
	...
	$arq1 = "../../files/".$modGet."/".$rSqlItem['numeroUnico']."/".$rSqlItem['arquivo'].""; //nome do arquivo a ser compactado
...
while($rSqlItem = mysql_fetch_array($qSqlItem)) {
	...
	$arq1 = "../../files/".$mod2Get."/".$rSqlItem['numeroUnico']."/".$rSqlItem['imagem'].""; //nome do arquivo a ser compactado
