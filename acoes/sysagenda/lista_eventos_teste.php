...
$qSql = mysql_query("SELECT * FROM sysagenda WHERE data_inicio BETWEEN '0000-00-00 00:00:00' AND '9999-12-31 23:59:59' ".$pesquisaListaIds." AND criador='".$criadorGet."' OR lista_admin LIKE '%|".$criadorGet."|%'  ORDER BY data_inicio, hora_inicio");
while($rSql = mysql_fetch_array($qSql)) {
	...
	if(trim($sysagenda_categoria_set['cor'])=="") { $corSet = "#333333"; } else { $corSet = "#".$sysagenda_categoria_set['cor'].""; }
	...
	$busca[$i]['className'] = "categoria-".$rSql['idsysagenda_categoria']."";
