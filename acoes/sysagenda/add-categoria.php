...
$qall = mysql_query("SELECT * FROM sysagenda_categoria WHERE criador='".$criadorGet."' ORDER BY ordem");
...
$insert = mysql_query("INSERT INTO sysagenda_categoria (criador,cor,ordem,nome,stat,data,dataModificacao) 
													VALUES 
