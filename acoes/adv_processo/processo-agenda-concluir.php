...
$logAcao = "Concluiu";
$logLocal = "Tarefa";
$logDescricao = "[8] ".$sysusuLog['nome']." concluiu o item <b>".$itemAntes['nome']."</b> de id <b title=\"adv_processo\">".$itemAntes['id']."</b>";
$logData = $data;
gravaLog($logPerfil,$logId,$logAcao,$logLocal,$logDescricao,$logData);

$update = mysql_query("UPDATE adv_processo_agenda SET concluidor='".$sysusuLog['id']."',concluido='".$acaoGet."',dataModificacao='".$data."' WHERE id='".$idGet."'");
