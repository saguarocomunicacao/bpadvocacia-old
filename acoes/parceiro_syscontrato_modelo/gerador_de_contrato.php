...
$rSqlProcesso = mysql_fetch_array(mysql_query("SELECT * FROM parceiro_adv_processo WHERE id='".$idProcessoGet."'"));

$rSqlContrato = mysql_fetch_array(mysql_query("SELECT * FROM parceiro_syscontrato_modelo WHERE id='".$idContratoGet."'"));

$rSqlUsuario = mysql_fetch_array(mysql_query("SELECT * FROM sysusu WHERE id='".$idUsuarioGet."'"));

$rSqlCliente = mysql_fetch_array(mysql_query("SELECT * FROM parceiro_syscliente WHERE id='".$idClienteGet."'"));

$rSqlClienteEndereco = mysql_fetch_array(mysql_query("SELECT * FROM parceiro_syscliente_endereco WHERE numeroUnico_pai='".$rSqlCliente['numeroUnico']."' AND principal='1'"));

$rSqlClienteTelefone = mysql_fetch_array(mysql_query("SELECT * FROM parceiro_syscliente_telefones WHERE numeroUnico_pai='".$rSqlCliente['numeroUnico']."' AND principal='1'"));
