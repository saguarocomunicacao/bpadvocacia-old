                                                                        ...
                                                                        <tr id="lista_categoria_<?=$rSqlCategoria['id']?>">
                                                                            ...
                                                                            <td style="vertical-align:middle;" class="nolink">
																				...
																				<? if(trim($rSqlCategoria['stat'])=="1") { ?>
                                                                                    <a href="javascript:void(0);" onclick="muda_stat_sysconta_a_receber_tipo_pagamento('<?=$modGet?>','<?=$rSqlCategoria['id']?>','<?=$subLocalGet?>','0');" class="btn-mini ptip_se" title="Despublicar"><img src="<?=$link?>template/img/icones_novos/16/stat-1.png" /></a>
                                                                                <? } else { ?>
                                                                                    <a href="javascript:void(0);" onclick="muda_stat_sysconta_a_receber_tipo_pagamento('<?=$modGet?>','<?=$rSqlCategoria['id']?>','<?=$subLocalGet?>','1');" class="btn-mini ptip_se" title="Publicar"><img src="<?=$link?>template/img/icones_novos/16/stat-0.png" /></a>
                                                                                <? } ?>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
