                                                                    ...
                                                                    <tbody>
                                                                        <?
																		$qSqlCategoria = mysql_query("SELECT * FROM parceiro_adv_processo_parceiro_syscliente WHERE idparceiro_syscliente='".$idparceiro_sysclienteGet."' ORDER BY data DESC");
                                                                        while($rSqlCategoria = mysql_fetch_array($qSqlCategoria)) {
                                                                        ?>
                                                                        
                                                                        <tr>
                                                                            <? $rSqlAdvProcesso = mysql_fetch_array(mysql_query("SELECT * FROM parceiro_adv_processo WHERE numeroUnico='".$rSqlCategoria['numeroUnico_pai']."'")); ?>
