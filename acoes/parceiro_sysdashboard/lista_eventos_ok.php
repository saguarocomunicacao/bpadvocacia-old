...
$qSql = mysql_query("SELECT * FROM parceiro_syscronograma WHERE data BETWEEN '0000-00-00 00:00:00' AND '9999-12-31 23:59:59' ORDER BY data_inicio, hora_inicio");
...
$qSql = mysql_query("SELECT * FROM parceiro_adv_processo WHERE data BETWEEN '0000-00-00 00:00:00' AND '9999-12-31 23:59:59' ORDER BY data_inicio, hora_inicio");
while($rSql = mysql_fetch_array($qSql)) {
...
$qSql = mysql_query("SELECT * FROM parceiro_adv_processo_agenda WHERE data BETWEEN '0000-00-00 00:00:00' AND '9999-12-31 23:59:59' ORDER BY data_fim, hora_fim");
while($rSql = mysql_fetch_array($qSql)) {
