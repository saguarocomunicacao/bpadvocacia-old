...
$nordem = mysql_num_rows(mysql_query("SELECT * FROM syscronograma_item WHERE numeroUnico_pai='".$numeroUnicoGet."'"));
?>
    ...
    <div style="float:left;width:100%;">
        ...
        <div class="fileupload fileupload-new" data-provides="fileupload">
            ...
            <? } else { ?>
            <img id="arquivo-atual-imagem" src="<?=$link?>files/syscronograma_item/<?=$item['numeroUnico']?>/<?=$item['imagem']?>" alt="">
            <? } ?>
            </div>
            ...
            <a href="javascript:void(0);" onclick="remover_imagem('<?=$item['id']?>','syscronograma_item','imagem');" class="btn btn-small" data-dismiss="fileupload">Remover</a>
            <? } ?>
        </div>
