...
?>
                                                            <?
															$mod = "parceiro_syscliente";
															$row = mysql_fetch_array(mysql_query("SELECT * FROM parceiro_syscliente WHERE id='".$_REQUEST['idS']."'"));
                                                                    ...
                                                                    <div id="tbview_a" class="tab-pane active" style="min-height:350px;width:650px;">
                                                                        <div class="formSep">
                                                                            <div style="float:left;margin-right:10px;">
                                                                                ...
                                                                                <? $rSqlItem = mysql_fetch_array(mysql_query("SELECT * FROM parceiro_syscliente_categoria WHERE id='".$row['id'.$mod.'_categoria']."'")); ?>
                                                                    ...
                                                                    <div id="tbview_d" class="tab-pane" style="min-height:350px;">
                                                                        ...
                                                                        <div style="float:left;margin-top:10px;width:100%;padding-bottom:10px;border-top:1px dashed #CCCCCC;padding-top:10px;">
                                                                            <div id="lista_parceiro_syscliente_telefones" style="width:100%;float:left;">
                                                                                <? $sufixoGet = ""; $numeroUnicoGet = $numeroUnicoGerado; include("./lista_parceiro_syscliente_telefones.php"); ?>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div style="float:left;margin-top:10px;width:100%;padding-bottom:10px;border-top:1px dashed #CCCCCC;padding-top:10px;">
                                                                            <div id="lista_parceiro_syscliente_emails" style="width:100%;float:left;">
                                                                                <? $sufixoGet = ""; $numeroUnicoGet = $numeroUnicoGerado; include("./lista_parceiro_syscliente_emails.php"); ?>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div id="tbview_e" class="tab-pane" style="min-height:350px;">
                                                                        ...
                                                                        <div style="float:left;margin-top:10px;width:100%;padding-bottom:10px;border-top:1px dashed #CCCCCC;padding-top:10px;">
                                                                            <div id="lista_parceiro_syscliente_endereco" style="width:100%;float:left;">
                                                                                <? $sufixoGet = ""; $numeroUnicoGet = $numeroUnicoGerado; include("./lista_parceiro_syscliente_endereco.php"); ?>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div id="tbview_f" class="tab-pane" style="min-height:350px;">
                                                                        ...
                                                                        <div style="float:left;margin-top:10px;width:100%;padding-bottom:10px;border-top:1px dashed #CCCCCC;padding-top:10px;">
                                                                            ...
                                                                            <div id="lista_parceiro_syscliente_redes" style="width:100%;float:left;">
                                                                                <? $sufixoGet = ""; $numeroUnicoGet = $numeroUnicoGerado; include("./lista_parceiro_syscliente_redes.php"); ?>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div id="tbview_i" class="tab-pane" style="min-height:350px;">
                                                                        ...
                                                                        <div style="float:left;margin-top:10px;width:100%;padding-bottom:10px;border-top:1px dashed #CCCCCC;padding-top:10px;">
                                                                            <div id="lista_parceiro_syscliente_banco" style="width:100%;float:left;">
                                                                                <? $sufixoGet = ""; $numeroUnicoGet = $numeroUnicoGerado; include("./lista_parceiro_syscliente_banco.php"); ?>
                                                                            </div>
                                                                        </div>
