...
$item = mysql_fetch_array(mysql_query("SELECT * FROM parceiro_sysagenda WHERE id='".$idGet."'"));
...
$update = mysql_query("UPDATE parceiro_sysagenda SET data_inicio='".$dataI."',hora_inicio='".$horaI."',data_fim='".$dataF."',hora_fim='".$horaF."',dataModificacao='".$data."' WHERE id='".$idGet."'");
?>
