...
$qSql = mysql_query("SELECT * FROM parceiro_sysagenda WHERE data_inicio BETWEEN '0000-00-00 00:00:00' AND '9999-12-31 23:59:59' ".$pesquisaListaIds."  ORDER BY data_inicio, hora_inicio");
