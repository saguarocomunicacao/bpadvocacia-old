...
$qSql = mysql_query("SELECT * FROM syscronograma WHERE data BETWEEN '0000-00-00 00:00:00' AND '9999-12-31 23:59:59' ".$pesquisaListaIdsSyscronograma."  ORDER BY data_inicio, hora_inicio");
