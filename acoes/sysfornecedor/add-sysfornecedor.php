...
$insert = mysql_query("INSERT INTO sysfornecedor (numeroUnico,nome,email,senha,como_conheceu,como_conheceu_outro,telefone_1_operadora,telefone_1_ddd,telefone_1,stat,data,dataModificacao) 
													VALUES 
