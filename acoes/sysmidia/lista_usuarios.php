                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            <th>Nome</th>
                                                                            <th>Visualizar Pasta</th>
                                                                            <th>Criar Pasta</th>
                                                                            <th>Renomear Pasta</th>
                                                                            <th>Excluir Pasta</th>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="vertical-align:middle;"><? if(trim($rSqlPerm['visualizar_pasta'])==0) { echo "não"; } else { echo "sim"; } ?></td>
                                                                            <td style="vertical-align:middle;"><? if(trim($rSqlPerm['criar_pasta'])==0) { echo "não"; } else { echo "sim"; } ?></td>
                                                                            <td style="vertical-align:middle;"><? if(trim($rSqlPerm['renomear_pasta'])==0) { echo "não"; } else { echo "sim"; } ?></td>
                                                                            <td style="vertical-align:middle;"><? if(trim($rSqlPerm['excluir_pasta'])==0) { echo "não"; } else { echo "sim"; } ?></td>
                                                                            ...
                                                                            <td style="vertical-align:middle;" class="nolink">
                                                                                <div class="btn-group">
                                                                                <a href="javascript:void(0);" onClick="remover_usuario_perm('<?=$rSqlPerm['id']?>');" class="btn-mini ptip_se" title="Remover"><img src="<?=$link?>template/img/icones_novos/16/remover-x.png" /></a>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <? } ?>
